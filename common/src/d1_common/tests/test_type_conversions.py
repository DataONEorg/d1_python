...
class TestTypeConversions(unittest.TestCase):
  ...
  def test_0010(self):
    """is_v1()"""
    systemMetadata_v1_0_str = d1_test.util.read_test_file(
  ...
  def test_0020(self):
    """is_v2()"""
    systemMetadata_v2_0_str = d1_test.util.read_test_file(
  ...
  def test_0050(self):
    """LogEntry v1 to v2"""
    logEntry_v1_0_str = d1_test.util.read_test_file('logEntry_v1_0.xml')
  ...
  def test_0060(self):
    """LogEntry v2 to v1"""
    logEntry_v2_0_str = d1_test.util.read_test_file('logEntry_v2_0.xml')
  ...
  def test_0070(self):
    """Log v2 to v1"""
    log_v2_0_str = d1_test.util.read_test_file('log_v2_0.xml')
  ...
  def test_0080(self):
    """Node v2 to v1"""
    node_v2_0_str = d1_test.util.read_test_file('node_v2_0.xml')
  ...
  def test_0090(self):
    """NodeList v2 to v1"""
    node_list_v2_0_str = d1_test.util.read_test_file('nodeList_v2_0.xml')
