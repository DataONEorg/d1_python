...
class TestTypeConversions(d1_test.d1_test_case.D1TestCase):
  def test_1000(self):
    """is_v1()"""
    systemMetadata_v1_0_str = self.load_sample('systemMetadata_v1_0.xml')
    assert c.str_is_v1(systemMetadata_v1_0_str)
    assert not c.str_is_v2(systemMetadata_v1_0_str)

  def test_1010(self):
    """is_v2()"""
    systemMetadata_v2_0_str = self.load_sample('systemMetadata_v2_0.xml')
  ...
  def test_1040(self):
    """LogEntry v1 to v2"""
    logEntry_v1_0_str = self.load_sample('logEntry_v1_0.xml')
  ...
  def test_1050(self):
    """LogEntry v2 to v1"""
    logEntry_v2_0_str = self.load_sample('logEntry_v2_0.xml')
  ...
  def test_1060(self):
    """Log v2 to v1"""
    log_v2_0_str = self.load_sample('log_v2_0.xml')
  ...
  def test_1070(self):
    """Node v2 to v1"""
    node_v2_0_str = self.load_sample('node_v2_0.xml')
  ...
  def test_1080(self):
    """NodeList v2 to v1"""
    node_list_v2_0_str = self.load_sample('nodeList_v2_0.xml')
