...
class ResourceMap(rdflib.ConjunctiveGraph):
  ...
  def getAllPredicates(self):
    """
    Returns:
       list of str: All unique predicates
  ...
  def getAggregatedPids(self):
    """
    Returns:
      list of str: All aggregated PIDs
  ...
  def getAggregatedScienceMetadataPids(self):
    """
    Returns:
       list of str: All Science Metadata PIDs
  ...
  def getAggregatedScienceDataPids(self):
    """
    Returns:
       list of str: All Science Data PIDs
  ...
  def parseDoc(self, doc_str, format="xml"):
    ...
    See Also:
      ``rdflib.ConjunctiveGraph.parse`` for documentation on arguments.
    """
