...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier(
    'urn:uuid:c957bb0a-b359-11e7-b444-080027018ba0'
)
...
class DataONEException(pyxb.binding.basis.complexTypeDefinition):
    """Defines a structure for serializing DataONE Exceptions."""
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        '/home/dahl/dev/d1_python/lib_common/src/d1_common/types/schemas/dataoneErrors.xsd',
        35,
        2,
    )
    _ElementMap = {}
    ...
    __errorCode = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, 'errorCode'),
        'errorCode',
    ...
    __detailCode = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, 'detailCode'),
        'detailCode',
    ...
    __identifier = pyxb.binding.content.AttributeUse(
        ...
        'identifier',
        '__AbsentNamespace0_DataONEException_identifier',
        pyxb.binding.datatypes.string,
    )
    ...
    __nodeId = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, 'nodeId'),
        'nodeId',
        '__AbsentNamespace0_DataONEException_nodeId',
        pyxb.binding.datatypes.string,
    )
...
error = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, 'error'),
    DataONEException,
