...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier(
  'urn:uuid:e9f12ebe-c122-11e3-95ce-000c294230b4'
)
...
class Folder(pyxb.binding.basis.complexTypeDefinition):
  ...
  _XSDLocation = pyxb.utils.utility.Location(
    '/home/dahl/d1/d1_python/d1_workspace_client/src/d1_workspace/types/workspace_types.xsd',
    7, 2
  )
  _ElementMap = {}
  _AttributeMap = {}
  ...
  __folder = pyxb.binding.content.ElementDeclaration(
    pyxb.namespace.ExpandedName(None, u'folder'),
    'folder',
    '__AbsentNamespace0_Folder_folder',
    True,
  ...
  __identifier = pyxb.binding.content.ElementDeclaration(
    pyxb.namespace.ExpandedName(None, u'identifier'),
    'identifier',
    '__AbsentNamespace0_Folder_identifier',
    True,
    pyxb.utils.utility.Location(
      '/home/dahl/d1/d1_python/d1_workspace_client/src/d1_workspace/types/workspace_types.xsd',
      10, 6
  ...
  __query = pyxb.binding.content.ElementDeclaration(
    pyxb.namespace.ExpandedName(None, u'query'),
    'query',
    '__AbsentNamespace0_Folder_query',
    True,
    pyxb.utils.utility.Location(
      '/home/dahl/d1/d1_python/d1_workspace_client/src/d1_workspace/types/workspace_types.xsd',
      11, 6
  ...
  __name = pyxb.binding.content.AttributeUse(
    ...
    '__AbsentNamespace0_Folder_name', pyxb.binding.datatypes.string,
    required=True
  )
...
folder = pyxb.binding.basis.element(
  pyxb.namespace.ExpandedName(Namespace, u'folder'), Folder,
...
Folder._AddElement(
  pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(None, u'folder'), Folder, scope=Folder,
    location=pyxb.utils.utility.Location(
      '/home/dahl/d1/d1_python/d1_workspace_client/src/d1_workspace/types/workspace_types.xsd',
      9, 6
    )
...
Folder._AddElement(
  pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(None, u'identifier'), pyxb.binding.datatypes.
    string, scope=Folder, location=pyxb.utils.utility.Location(
      '/home/dahl/d1/d1_python/d1_workspace_client/src/d1_workspace/types/workspace_types.xsd',
      10, 6
    )
  )
...
Folder._AddElement(
  pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(None, u'query'), pyxb.binding.datatypes.string,
    scope=Folder, location=pyxb.utils.utility.Location(
      '/home/dahl/d1/d1_python/d1_workspace_client/src/d1_workspace/types/workspace_types.xsd',
      11, 6
    )
  )
...
def _BuildAutomaton():
  ...
  cc_0 = fac.CounterCondition(
    min=0L, max=None, metadata=pyxb.utils.utility.Location(
      '/home/dahl/d1/d1_python/d1_workspace_client/src/d1_workspace/types/workspace_types.xsd',
      9, 6
    )
  )
  ...
  symbol = pyxb.binding.content.ElementUse(
    Folder._UseForTag(pyxb.namespace.ExpandedName(None, u'folder')),
    pyxb.utils.utility.Location(
      '/home/dahl/d1/d1_python/d1_workspace_client/src/d1_workspace/types/workspace_types.xsd',
      9, 6
    )
  ...
  symbol = pyxb.binding.content.ElementUse(
    Folder._UseForTag(pyxb.namespace.ExpandedName(None, u'identifier')),
    pyxb.utils.utility.Location(
      '/home/dahl/d1/d1_python/d1_workspace_client/src/d1_workspace/types/workspace_types.xsd',
      10, 6
    )
  ...
  symbol = pyxb.binding.content.ElementUse(
    Folder._UseForTag(pyxb.namespace.ExpandedName(None, u'query')),
    pyxb.utils.utility.Location(
      '/home/dahl/d1/d1_python/d1_workspace_client/src/d1_workspace/types/workspace_types.xsd',
      11, 6
    )
