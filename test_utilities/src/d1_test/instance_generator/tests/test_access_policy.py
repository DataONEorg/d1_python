...
class TestAccessPolicy(d1_test.d1_test_case.D1TestCase):
    def test_1000(self):
        ...
        permissions = d1_test.instance_generator.access_policy.random_set_of_permissions()
    ...
    def test_1010(self):
        ...
        permissions = d1_test.instance_generator.access_policy.random_set_of_permissions()
        s = d1_test.instance_generator.access_policy.permissions_to_tag_string(permissions)
        self.sample.assert_equals(s, 'inst_gen_permissions_to_tag_string')

    def test_1020(self):
        """random_subject_with_permission_labels()"""
        permissions = d1_test.instance_generator.access_policy.random_set_of_permissions()
        s = d1_test.instance_generator.access_policy.random_subject_with_permission_labels(permissions)
        self.sample.assert_equals(s, 'inst_gen_random_subject_with_permission_labels')

    def test_1030(self):
        """random_subjects_with_permission_labels()"""
        permissions = d1_test.instance_generator.access_policy.random_set_of_permissions()
        subjects = d1_test.instance_generator.access_policy.random_subject_list_with_permission_labels(permissions)
        self.sample.assert_equals(
