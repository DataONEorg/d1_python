...
# MNCore.getLogRecords()
  ...
  def _getLogRecords_v2(self, base_url):
    ...
    client = d1baseclient_2_0.DataONEBaseClient_2_0(
      base_url, types=d1_common.types.dataoneTypes,
      version='v1'
    )
  ...
  def test_120_v2(self):
    ...
    log = self._getLogRecords_v2(settings.MN_URL)
  ...
  def test_200_v2(self):
    '''ping() CN'''
    self._ping_v2(settings.CN_URL)

  def test_210_v2(self):
    '''ping() MN'''
    self._ping_v2(settings.MN_URL)
  ...
  def _get_sysmeta_v2(self, base_url, invalid_pid=False):
    ...
    self.assertTrue(isinstance(sysmeta, d1_common.types.dataoneTypes_2_0.SystemMetadata))
