...
#         self.parser = data_package.ResourceMapParser()
  ...
  # 
  #=========================================================================
  @mock.patch.object(data_package.ResourceMapGenerator, '_serialize_resource_map')
  @mock.patch.object(data_package.ResourceMapGenerator, '_generate_resource_map')
  @mock.patch.object(data_package.ResourceMapGenerator, '_aggregation_uri_from_pid')
  ...
  @mock.patch.object(data_package.ResourceMapGenerator, '_resolvable_uri_from_pid')
  ...
  def test_generate_sys_meta(self, mock_types, mock_generate):
    ...
    with mock.patch('data_package.datetime.datetime') as mock_datetime:
      ...
      self.assertEqual(
        str(
          output.dateSysMetadataModified
