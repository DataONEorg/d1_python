<!--
XSLT applied to eml-2.0.1 eml.xsd.
...
The additionalMetadata structure in eml-2.0.1/eml.xsd contains such a structure. This
works around the issue by removing the additionalMetadata/any structure from the
eml.xsd.

A corresponding transform that removes additionalMetadata/any elements from eml-2.0.1
