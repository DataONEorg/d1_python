...
class TestRegionResolver(d1_test.d1_test_case.D1TestCase):
    ...
    def test_1020(self):
        ...
        assert dst == {
            'd2': {
                'd21': {'testpid': None},
                'd22': {'testpid': None, 'd31': {'testpid': None}},
                'testpid': None,
            },
            'd1': {'testpid': None},
        }
    ...
    def test_1030(self):
        ...
        assert dst == {
            ...
            'd3': {
                'd32': {'testpid': None},
                'testpid': None,
                'd31': {'d311': {'testpid': None}, 'testpid': None},
            },
            'd1': {'f21': None, 'testpid': None},
        }
    ...
    def test_1040(self):
        ...
        src = {
            'd1': {'f11': None},
            'd2': {},
            'd3': {'d31': {'d311': {'f3111': None}}, 'd32': {}},
        }
        self._resolver._merge_region_trees(dst, src, 'x')
        assert dst == {
            'f1': None,
            'd2': {'d21': {}, 'x': None, 'd22': {'d31': {}}},
            'd3': {
                'x': None,
                'd32': {'x': None},
                'd31': {'x': None, 'd311': {'x': None, 'f3111': {'x': None}}},
            },
            'd1': {'x': None, 'f11': {'x': None}, 'd11': {}, 'd12': {'f121': None}},
        }
