...
Namespace = pyxb.namespace.NamespaceForURI(
  u'http://dataone.org/service/types/NodeRegistry/0.1',
...
class Node(pyxb.binding.basis.complexTypeDefinition):
  ...
  __synchronization = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'synchronization'
    ), 'synchronization',
    '__httpdataone_orgservicetypesNodeRegistry0_1_Node_synchronization', False
  )
  ...
  __identifier = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'identifier'
    ), 'identifier', '__httpdataone_orgservicetypesNodeRegistry0_1_Node_identifier', False
  )

  identifier = property(__identifier.value, __identifier.set, None, None)

  # Element name uses Python identifier name
  __name = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'name'
    ), 'name', '__httpdataone_orgservicetypesNodeRegistry0_1_Node_name', False
  )

  name = property(__name.value, __name.set, None, None)

  # Element baseURL uses Python identifier baseURL
  __baseURL = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'baseURL'
    ), 'baseURL', '__httpdataone_orgservicetypesNodeRegistry0_1_Node_baseURL', False
  )

  baseURL = property(__baseURL.value, __baseURL.set, None, None)

  # Element services uses Python identifier services
  __services = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'services'
    ), 'services', '__httpdataone_orgservicetypesNodeRegistry0_1_Node_services', False
  )
  ...
  __synchronize = pyxb.binding.content.AttributeUse(
    ...
    'synchronize',
    '__httpdataone_orgservicetypesNodeRegistry0_1_Node_synchronize',
  ...
  __replicate = pyxb.binding.content.AttributeUse(
    ...
    'replicate',
    '__httpdataone_orgservicetypesNodeRegistry0_1_Node_replicate',
    pyxb.binding.datatypes.boolean,
    required=True
  )
  ...
  __type = pyxb.binding.content.AttributeUse(
    ...
    'type',
    '__httpdataone_orgservicetypesNodeRegistry0_1_Node_type',
...
class Services(pyxb.binding.basis.complexTypeDefinition):
  ...
  __service = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'service'
    ), 'service', '__httpdataone_orgservicetypesNodeRegistry0_1_Services_service', True
  )

  service = property(__service.value, __service.set, None, None)

  _ElementMap = {__service.name(): __service}
  _AttributeMap = {}
...
class Synchronization(pyxb.binding.basis.complexTypeDefinition):
  ...
  __lastCompleteHarvest = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'lastCompleteHarvest'
    ), 'lastCompleteHarvest',
    '__httpdataone_orgservicetypesNodeRegistry0_1_Synchronization_lastCompleteHarvest',
    False
  )

  lastCompleteHarvest = property(
    __lastCompleteHarvest.value, __lastCompleteHarvest.set, None, None
  )

  # Element schedule uses Python identifier schedule
  __schedule = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'schedule'
    ), 'schedule',
    '__httpdataone_orgservicetypesNodeRegistry0_1_Synchronization_schedule', False
  )

  schedule = property(__schedule.value, __schedule.set, None, None)

  # Element lastHarvested uses Python identifier lastHarvested
  __lastHarvested = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'lastHarvested'
    ), 'lastHarvested',
    '__httpdataone_orgservicetypesNodeRegistry0_1_Synchronization_lastHarvested', False
  )
...
class Service(pyxb.binding.basis.complexTypeDefinition):
  ...
  __available = pyxb.binding.content.AttributeUse(
    ...
    'available',
    '__httpdataone_orgservicetypesNodeRegistry0_1_Service_available',
    pyxb.binding.datatypes.boolean,
    required=True
  )
  ...
  __api = pyxb.binding.content.AttributeUse(
    pyxb.namespace.ExpandedName(
      None, u'api'
    ),
    'api',
    '__httpdataone_orgservicetypesNodeRegistry0_1_Service_api',
    pyxb.binding.datatypes.NCName,
    required=True
  )
  ...
  __method = pyxb.binding.content.AttributeUse(
    pyxb.namespace.ExpandedName(
      None, u'method'
    ),
    'method',
    '__httpdataone_orgservicetypesNodeRegistry0_1_Service_method',
    pyxb.binding.datatypes.NCName,
    required=True
  )
  ...
  __datechecked = pyxb.binding.content.AttributeUse(
    pyxb.namespace.ExpandedName(
      None, u'datechecked'
    ),
    'datechecked',
    '__httpdataone_orgservicetypesNodeRegistry0_1_Service_datechecked',
  ...
  __rest = pyxb.binding.content.AttributeUse(
    pyxb.namespace.ExpandedName(
      None, u'rest'
    ),
    'rest',
    '__httpdataone_orgservicetypesNodeRegistry0_1_Service_rest',
...
class Schedule(pyxb.binding.basis.complexTypeDefinition):
  ...
  __hour = pyxb.binding.content.AttributeUse(
    ...
    'hour',
    '__httpdataone_orgservicetypesNodeRegistry0_1_Schedule_hour',
    crontabEntryType,
    required=True
  )
  ...
  __mon = pyxb.binding.content.AttributeUse(
    ...
    'mon',
    '__httpdataone_orgservicetypesNodeRegistry0_1_Schedule_mon',
    crontabEntryType,
    required=True
  )
  ...
  __sec = pyxb.binding.content.AttributeUse(
    ...
    'sec',
    '__httpdataone_orgservicetypesNodeRegistry0_1_Schedule_sec',
    crontabEntryType,
    required=True
  )
  ...
  __wday = pyxb.binding.content.AttributeUse(
    ...
    'wday',
    '__httpdataone_orgservicetypesNodeRegistry0_1_Schedule_wday',
    crontabEntryType,
    required=True
  )
  ...
  __year = pyxb.binding.content.AttributeUse(
    ...
    'year',
    '__httpdataone_orgservicetypesNodeRegistry0_1_Schedule_year',
    crontabEntryType,
    required=True
  )
  ...
  __mday = pyxb.binding.content.AttributeUse(
    ...
    'mday',
    '__httpdataone_orgservicetypesNodeRegistry0_1_Schedule_mday',
    crontabEntryType,
    required=True
  )
  ...
  __min = pyxb.binding.content.AttributeUse(
    ...
    'min',
    '__httpdataone_orgservicetypesNodeRegistry0_1_Schedule_min',
    crontabEntryType,
    required=True
  )
...
class CTD_ANON(pyxb.binding.basis.complexTypeDefinition):
  ...
  __node = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'node'
    ), 'node', '__httpdataone_orgservicetypesNodeRegistry0_1_CTD_ANON_node', True
  )

  node = property(__node.value, __node.set, None, None)

  _ElementMap = {__node.name(): __node}
  _AttributeMap = {}


nodeRegistry = pyxb.binding.basis.element(
  pyxb.namespace.ExpandedName(
    Namespace, u'nodeRegistry'
  ), CTD_ANON
)
Namespace.addCategoryObject(
  'elementBinding', nodeRegistry.name().localName(
  ), nodeRegistry
)
...
Node._ContentModel = pyxb.binding.content.ParticleModel(
  Node._GroupModel, min_occurs=1, max_occurs=1
)
...
Services._ContentModel = pyxb.binding.content.ParticleModel(
  Services._GroupModel, min_occurs=1, max_occurs=1
)
...
Synchronization._ContentModel = pyxb.binding.content.ParticleModel(
  Synchronization._GroupModel, min_occurs=1,
  max_occurs=1
)
