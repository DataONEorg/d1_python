# d1common/types/objectlist.py
# PyXB bindings for NamespaceModule
# NSM:96ccb5882fb936073345ea8144478ca840b9133c
# Generated 2010-06-29 11:08:16.909341 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
Namespace = pyxb.namespace.NamespaceForURI(
  u'http://dataone.org/service/types/ObjectList/0.1',
...
class ObjectInfo(pyxb.binding.basis.complexTypeDefinition):
  ...
  __size = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'size'
    ), 'size', '__httpdataone_orgservicetypesObjectList0_1_ObjectInfo_size', False
  )
  ...
  __identifier = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'identifier'
    ), 'identifier', '__httpdataone_orgservicetypesObjectList0_1_ObjectInfo_identifier',
    False
  )
  ...
  __checksum = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'checksum'
    ), 'checksum', '__httpdataone_orgservicetypesObjectList0_1_ObjectInfo_checksum', False
  )
  ...
  __dateSysMetadataModified = pyxb.binding.content.ElementUse(
    ...
    '__httpdataone_orgservicetypesObjectList0_1_ObjectInfo_dateSysMetadataModified', False
  )
  ...
  __objectFormat = pyxb.binding.content.ElementUse(
    ...
    '__httpdataone_orgservicetypesObjectList0_1_ObjectInfo_objectFormat', False
  )
...
class ObjectList(pyxb.binding.basis.complexTypeDefinition):
  ...
  __objectInfo = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'objectInfo'
    ), 'objectInfo', '__httpdataone_orgservicetypesObjectList0_1_ObjectList_objectInfo',
    True
  )
  ...
  __count = pyxb.binding.content.AttributeUse(
    ...
    'count',
    '__httpdataone_orgservicetypesObjectList0_1_ObjectList_count',
  ...
  __start = pyxb.binding.content.AttributeUse(
    ...
    'start',
    '__httpdataone_orgservicetypesObjectList0_1_ObjectList_start',
    pyxb.binding.datatypes.int,
    required=True
  )
  ...
  __total = pyxb.binding.content.AttributeUse(
    ...
    'total',
    '__httpdataone_orgservicetypesObjectList0_1_ObjectList_total',
    pyxb.binding.datatypes.int,
    required=True
  )
  ...
  _ElementMap = {__objectInfo.name(): __objectInfo}
  _AttributeMap = {
...
ObjectInfo._ContentModel = pyxb.binding.content.ParticleModel(
  ObjectInfo._GroupModel, min_occurs=1, max_occurs=1
)
...
ObjectList._ContentModel = pyxb.binding.content.ParticleModel(
  ObjectList._GroupModel, min_occurs=1, max_occurs=1
)
