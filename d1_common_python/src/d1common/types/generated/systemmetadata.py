...
class AccessRule (pyxb.binding.basis.complexTypeDefinition):
    ...
    __service = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'service'), 'service', '__httpdataone_orgservicetypesSystemMetadata0_1_AccessRule_service', STD_ANON_)
    
    service = property(__service.value, __service.set, None, None)

    
    # Attribute rule uses Python identifier rule
    __rule = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'rule'), 'rule', '__httpdataone_orgservicetypesSystemMetadata0_1_AccessRule_rule', STD_ANON)
