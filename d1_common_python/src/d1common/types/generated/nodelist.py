...
class Status (pyxb.binding.basis.complexTypeDefinition):
    ...
    __dateChecked = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'dateChecked'), 'dateChecked', '__httpdataone_orgservicetypesNodeList0_1_Status_dateChecked', pyxb.binding.datatypes.dateTime, required=True)
    
    dateChecked = property(__dateChecked.value, __dateChecked.set, None, None)

    
    # Attribute success uses Python identifier success
    __success = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'success'), 'success', '__httpdataone_orgservicetypesNodeList0_1_Status_success', pyxb.binding.datatypes.boolean)
...
class Service (pyxb.binding.basis.complexTypeDefinition):
    ...
    __method = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'method'), 'method', '__httpdataone_orgservicetypesNodeList0_1_Service_method', True)
...
class ServiceMethod (pyxb.binding.basis.complexTypeDefinition):
    ...
    __implemented = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'implemented'), 'implemented', '__httpdataone_orgservicetypesNodeList0_1_ServiceMethod_implemented', pyxb.binding.datatypes.boolean, required=True)
    
    implemented = property(__implemented.value, __implemented.set, None, None)

    
    # Attribute name uses Python identifier name
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpdataone_orgservicetypesNodeList0_1_ServiceMethod_name', pyxb.binding.datatypes.NMTOKEN)
    
    name = property(__name.value, __name.set, None, None)

    
    # Attribute rest uses Python identifier rest
    __rest = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'rest'), 'rest', '__httpdataone_orgservicetypesNodeList0_1_ServiceMethod_rest', pyxb.binding.datatypes.token, required=True)
