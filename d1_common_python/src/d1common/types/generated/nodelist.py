...
# Generated 2010-07-28 14:53:50.797300 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
Namespace = pyxb.namespace.NamespaceForURI(u'http://dataone.org/service/types/NodeList/0.1', create_if_missing=True)
...
class Service (pyxb.binding.basis.complexTypeDefinition):
    ...
    __available = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'available'), 'available', '__httpdataone_orgservicetypesNodeList0_1_Service_available', pyxb.binding.datatypes.boolean, required=True)
    
    available = property(__available.value, __available.set, None, None)

    
    # Attribute api uses Python identifier api
    __api = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'api'), 'api', '__httpdataone_orgservicetypesNodeList0_1_Service_api', pyxb.binding.datatypes.NCName, required=True)
    
    api = property(__api.value, __api.set, None, None)

    
    # Attribute method uses Python identifier method
    __method = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'method'), 'method', '__httpdataone_orgservicetypesNodeList0_1_Service_method', pyxb.binding.datatypes.NCName, required=True)
    
    method = property(__method.value, __method.set, None, None)

    
    # Attribute rest uses Python identifier rest
    __rest = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'rest'), 'rest', '__httpdataone_orgservicetypesNodeList0_1_Service_rest', pyxb.binding.datatypes.string, required=True)
    
    rest = property(__rest.value, __rest.set, None, None)

    
    # Attribute datechecked uses Python identifier datechecked
    __datechecked = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'datechecked'), 'datechecked', '__httpdataone_orgservicetypesNodeList0_1_Service_datechecked', pyxb.binding.datatypes.dateTime, required=True)
...
class Node (pyxb.binding.basis.complexTypeDefinition):
    ...
    __type = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'type'), 'type', '__httpdataone_orgservicetypesNodeList0_1_Node_type', pyxb.binding.datatypes.NCName, required=True)
...
class Synchronization (pyxb.binding.basis.complexTypeDefinition):
    ...
    __lastCompleteHarvest = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'lastCompleteHarvest'), 'lastCompleteHarvest', '__httpdataone_orgservicetypesNodeList0_1_Synchronization_lastCompleteHarvest', False)
    ...
    __schedule = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'schedule'), 'schedule', '__httpdataone_orgservicetypesNodeList0_1_Synchronization_schedule', False)
    ...
    __lastHarvested = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'lastHarvested'), 'lastHarvested', '__httpdataone_orgservicetypesNodeList0_1_Synchronization_lastHarvested', False)
...
class NodeList (pyxb.binding.basis.complexTypeDefinition):
    ...
    __node = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'node'), 'node', '__httpdataone_orgservicetypesNodeList0_1_NodeList_node', True)
...
Node._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'identifier'), _common.NodeReference, scope=Node, documentation=u'A unique identifier for the node.  This may initially \n        be the same as the baseURL, however this value should not change for \n        future implementations of the same node, whereas the baseURL may change \n        in the future.\n        '))

Node._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'name'), _common.NonEmptyString, scope=Node))
