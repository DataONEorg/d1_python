# d1common/types/systemmetadata.py
# PyXB bindings for NamespaceModule
# NSM:ad83a62b16c5ba4e749e404d671cad04fd140a97
# Generated 2010-06-29 11:08:16.909148 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier(
  'urn:uuid:23603098-8390-11df-9bc3-00264a005868'
)
...
Namespace = pyxb.namespace.NamespaceForURI(
  u'http://dataone.org/service/types/SystemMetadata/0.1',
...
def CreateFromDOM(node, default_namespace=None):
  ...
  return pyxb.binding.basis.element.AnyCreateFromDOM(
    node, _fallback_namespace=default_namespace
  )
...
STD_ANON_.changePermission = STD_ANON_._CF_enumeration.addEnumeration(
...
STD_ANON_3.requested = STD_ANON_3._CF_enumeration.addEnumeration(
  unicode_value=u'requested'
)
STD_ANON_3.completed = STD_ANON_3._CF_enumeration.addEnumeration(
  unicode_value=u'completed'
)
STD_ANON_3.invalidated = STD_ANON_3._CF_enumeration.addEnumeration(
  unicode_value=u'invalidated'
)
...
class AccessRule(pyxb.binding.basis.complexTypeDefinition):
  ...
  __service = pyxb.binding.content.AttributeUse(
    pyxb.namespace.ExpandedName(
      None, u'service'
    ), 'service', '__httpdataone_orgservicetypesSystemMetadata0_1_AccessRule_service',
    STD_ANON_
  )
  ...
  __rule = pyxb.binding.content.AttributeUse(
    pyxb.namespace.ExpandedName(
      None, u'rule'
    ), 'rule', '__httpdataone_orgservicetypesSystemMetadata0_1_AccessRule_rule', STD_ANON
  )

  rule = property(__rule.value, __rule.set, None, None)

  # Attribute principal uses Python identifier principal
  __principal = pyxb.binding.content.AttributeUse(
    pyxb.namespace.ExpandedName(
      None, u'principal'
    ), 'principal', '__httpdataone_orgservicetypesSystemMetadata0_1_AccessRule_principal',
    _common.Principal
  )
...
class ReplicationPolicy(pyxb.binding.basis.complexTypeDefinition):
  ...
  __blockedMemberNode = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'blockedMemberNode'
    ), 'blockedMemberNode',
    '__httpdataone_orgservicetypesSystemMetadata0_1_ReplicationPolicy_blockedMemberNode',
    True
  )

  blockedMemberNode = property(
    __blockedMemberNode.value, __blockedMemberNode.set, None, None
  )

  # Element preferredMemberNode uses Python identifier preferredMemberNode
  __preferredMemberNode = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'preferredMemberNode'
    ), 'preferredMemberNode',
    '__httpdataone_orgservicetypesSystemMetadata0_1_ReplicationPolicy_preferredMemberNode',
    True
  )

  preferredMemberNode = property(
    __preferredMemberNode.value, __preferredMemberNode.set, None, None
  )
  ...
  __replicationAllowed = pyxb.binding.content.AttributeUse(
    ...
    '__httpdataone_orgservicetypesSystemMetadata0_1_ReplicationPolicy_replicationAllowed',
    STD_ANON_2
  )

  replicationAllowed = property(
    __replicationAllowed.value, __replicationAllowed.set, None, None
  )
  ...
  __numberReplicas = pyxb.binding.content.AttributeUse(
    ...
    '__httpdataone_orgservicetypesSystemMetadata0_1_ReplicationPolicy_numberReplicas',
...
class SystemMetadata(pyxb.binding.basis.complexTypeDefinition):
  ...
  __originMemberNode = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'originMemberNode'
    ), 'originMemberNode',
    '__httpdataone_orgservicetypesSystemMetadata0_1_SystemMetadata_originMemberNode',
    False
  )

  originMemberNode = property(
    __originMemberNode.value, __originMemberNode.set, None, None
  )

  # Element rightsHolder uses Python identifier rightsHolder
  __rightsHolder = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'rightsHolder'
    ), 'rightsHolder',
    '__httpdataone_orgservicetypesSystemMetadata0_1_SystemMetadata_rightsHolder', False
  )
  ...
  __submitter = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'submitter'
    ), 'submitter',
    '__httpdataone_orgservicetypesSystemMetadata0_1_SystemMetadata_submitter', False
  )

  submitter = property(__submitter.value, __submitter.set, None, None)

  # Element obsoletes uses Python identifier obsoletes
  __obsoletes = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'obsoletes'
    ), 'obsoletes',
    '__httpdataone_orgservicetypesSystemMetadata0_1_SystemMetadata_obsoletes', True
  )

  obsoletes = property(__obsoletes.value, __obsoletes.set, None, None)

  # Element size uses Python identifier size
  __size = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'size'
    ), 'size', '__httpdataone_orgservicetypesSystemMetadata0_1_SystemMetadata_size', False
  )

  size = property(__size.value, __size.set, None, None)

  # Element replica uses Python identifier replica
  __replica = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'replica'
    ), 'replica', '__httpdataone_orgservicetypesSystemMetadata0_1_SystemMetadata_replica',
    True
  )
  ...
  __replicationPolicy = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'replicationPolicy'
    ), 'replicationPolicy',
    '__httpdataone_orgservicetypesSystemMetadata0_1_SystemMetadata_replicationPolicy',
    False
  )

  replicationPolicy = property(
    __replicationPolicy.value, __replicationPolicy.set, None, None
  )

  # Element derivedFrom uses Python identifier derivedFrom
  __derivedFrom = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'derivedFrom'
    ), 'derivedFrom',
    '__httpdataone_orgservicetypesSystemMetadata0_1_SystemMetadata_derivedFrom', True
  )
  ...
  __dateUploaded = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'dateUploaded'
    ), 'dateUploaded',
    '__httpdataone_orgservicetypesSystemMetadata0_1_SystemMetadata_dateUploaded', False
  )
  ...
  __accessRule = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'accessRule'
    ), 'accessRule',
    '__httpdataone_orgservicetypesSystemMetadata0_1_SystemMetadata_accessRule', True
  )

  accessRule = property(__accessRule.value, __accessRule.set, None, None)

  # Element identifier uses Python identifier identifier
  __identifier = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'identifier'
    ), 'identifier',
    '__httpdataone_orgservicetypesSystemMetadata0_1_SystemMetadata_identifier', False
  )

  identifier = property(__identifier.value, __identifier.set, None, None)

  # Element describes uses Python identifier describes
  __describes = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'describes'
    ), 'describes',
    '__httpdataone_orgservicetypesSystemMetadata0_1_SystemMetadata_describes', True
  )
  ...
  __dateSysMetadataModified = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'dateSysMetadataModified'
    ), 'dateSysMetadataModified',
    '__httpdataone_orgservicetypesSystemMetadata0_1_SystemMetadata_dateSysMetadataModified',
    False
  )
  ...
  __describedBy = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'describedBy'
    ), 'describedBy',
    '__httpdataone_orgservicetypesSystemMetadata0_1_SystemMetadata_describedBy', True
  )
  ...
  __obsoletedBy = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'obsoletedBy'
    ), 'obsoletedBy',
    '__httpdataone_orgservicetypesSystemMetadata0_1_SystemMetadata_obsoletedBy', True
  )

  obsoletedBy = property(__obsoletedBy.value, __obsoletedBy.set, None, None)

  # Element checksum uses Python identifier checksum
  __checksum = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'checksum'
    ), 'checksum',
    '__httpdataone_orgservicetypesSystemMetadata0_1_SystemMetadata_checksum', False
  )

  checksum = property(__checksum.value, __checksum.set, None, None)

  # Element objectFormat uses Python identifier objectFormat
  __objectFormat = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'objectFormat'
    ), 'objectFormat',
    '__httpdataone_orgservicetypesSystemMetadata0_1_SystemMetadata_objectFormat', False
  )
  ...
  __authoritativeMemberNode = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'authoritativeMemberNode'
    ), 'authoritativeMemberNode',
    '__httpdataone_orgservicetypesSystemMetadata0_1_SystemMetadata_authoritativeMemberNode',
    False
  )

  authoritativeMemberNode = property(
    __authoritativeMemberNode.value, __authoritativeMemberNode.set, None, None
  )

  # Element embargoExpires uses Python identifier embargoExpires
  __embargoExpires = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'embargoExpires'
    ), 'embargoExpires',
    '__httpdataone_orgservicetypesSystemMetadata0_1_SystemMetadata_embargoExpires', False
  )
...
class CTD_ANON(pyxb.binding.basis.complexTypeDefinition):
  ...
  __replicaVerified = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'replicaVerified'
    ), 'replicaVerified',
    '__httpdataone_orgservicetypesSystemMetadata0_1_CTD_ANON_replicaVerified', False
  )
  ...
  __replicaMemberNode = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'replicaMemberNode'
    ), 'replicaMemberNode',
    '__httpdataone_orgservicetypesSystemMetadata0_1_CTD_ANON_replicaMemberNode', False
  )

  replicaMemberNode = property(
    __replicaMemberNode.value, __replicaMemberNode.set, None, None
  )

  # Element replicationStatus uses Python identifier replicationStatus
  __replicationStatus = pyxb.binding.content.ElementUse(
    pyxb.namespace.ExpandedName(
      None, u'replicationStatus'
    ), 'replicationStatus',
    '__httpdataone_orgservicetypesSystemMetadata0_1_CTD_ANON_replicationStatus', False
  )

  replicationStatus = property(
    __replicationStatus.value, __replicationStatus.set, None, None
  )
...
ReplicationPolicy._ContentModel = pyxb.binding.content.ParticleModel(
  ReplicationPolicy._GroupModel, min_occurs=1,
  max_occurs=1
)
...
SystemMetadata._ContentModel = pyxb.binding.content.ParticleModel(
  SystemMetadata._GroupModel, min_occurs=1,
  max_occurs=1
)
...
CTD_ANON._ContentModel = pyxb.binding.content.ParticleModel(
  CTD_ANON._GroupModel, min_occurs=1, max_occurs=1
)
