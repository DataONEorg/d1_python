...
# NSM:a1b30c8fd22f9b92095609553b664ab8431c386e
# Generated 2011-07-13 10:08:53.036997 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:670301ea-ad6a-11e0-9486-000c294230b4')

# Import bindings for namespaces imported into schema
import pyxb.binding.datatypes

Namespace = pyxb.namespace.NamespaceForURI(u'http://ns.dataone.org/service/types/0.6.2', create_if_missing=True)
...
class ComponentList (pyxb.binding.basis.complexTypeDefinition):
    ...
    __component = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'component'), 'component', '__httpns_dataone_orgservicetypes0_6_2_ComponentList_component', False)
...
class NodeList (pyxb.binding.basis.complexTypeDefinition):
    ...
    __node = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'node'), 'node', '__httpns_dataone_orgservicetypes0_6_2_NodeList_node', True)
...
class Slice (pyxb.binding.basis.complexTypeDefinition):
    ...
    __count = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'count'), 'count', '__httpns_dataone_orgservicetypes0_6_2_Slice_count', pyxb.binding.datatypes.int, required=True)
    
    count = property(__count.value, __count.set, None, None)

    
    # Attribute start uses Python identifier start
    __start = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'start'), 'start', '__httpns_dataone_orgservicetypes0_6_2_Slice_start', pyxb.binding.datatypes.int, required=True)
    
    start = property(__start.value, __start.set, None, None)

    
    # Attribute total uses Python identifier total
    __total = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'total'), 'total', '__httpns_dataone_orgservicetypes0_6_2_Slice_total', pyxb.binding.datatypes.int, required=True)
...
class ObjectFormatList (Slice):
    ...
    __objectFormat = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'objectFormat'), 'objectFormat', '__httpns_dataone_orgservicetypes0_6_2_ObjectFormatList_objectFormat', True)

    
    objectFormat = property(__objectFormat.value, __objectFormat.set, None, None)

    
    # Attribute count inherited from {http://ns.dataone.org/service/types/0.6.2}Slice
    
    # Attribute start inherited from {http://ns.dataone.org/service/types/0.6.2}Slice
    
    # Attribute total inherited from {http://ns.dataone.org/service/types/0.6.2}Slice
...
class SystemMetadata (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element objectFormat uses Python identifier objectFormat
    __objectFormat = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'objectFormat'), 'objectFormat', '__httpns_dataone_orgservicetypes0_6_2_SystemMetadata_objectFormat', False)
    ...
    __dateUploaded = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'dateUploaded'), 'dateUploaded', '__httpns_dataone_orgservicetypes0_6_2_SystemMetadata_dateUploaded', False)
    ...
    __accessPolicy = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'accessPolicy'), 'accessPolicy', '__httpns_dataone_orgservicetypes0_6_2_SystemMetadata_accessPolicy', False)
    ...
    __embargoExpires = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'embargoExpires'), 'embargoExpires', '__httpns_dataone_orgservicetypes0_6_2_SystemMetadata_embargoExpires', False)
    ...
    __authoritativeMemberNode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'authoritativeMemberNode'), 'authoritativeMemberNode', '__httpns_dataone_orgservicetypes0_6_2_SystemMetadata_authoritativeMemberNode', False)
    ...
    __replicationPolicy = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'replicationPolicy'), 'replicationPolicy', '__httpns_dataone_orgservicetypes0_6_2_SystemMetadata_replicationPolicy', False)
    ...
    __dateSysMetadataModified = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'dateSysMetadataModified'), 'dateSysMetadataModified', '__httpns_dataone_orgservicetypes0_6_2_SystemMetadata_dateSysMetadataModified', False)
    ...
    __identifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'identifier'), 'identifier', '__httpns_dataone_orgservicetypes0_6_2_SystemMetadata_identifier', False)
    ...
    __checksum = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'checksum'), 'checksum', '__httpns_dataone_orgservicetypes0_6_2_SystemMetadata_checksum', False)
    ...
    __obsoletedBy = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'obsoletedBy'), 'obsoletedBy', '__httpns_dataone_orgservicetypes0_6_2_SystemMetadata_obsoletedBy', True)
    ...
    __originMemberNode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'originMemberNode'), 'originMemberNode', '__httpns_dataone_orgservicetypes0_6_2_SystemMetadata_originMemberNode', False)
    ...
    __derivedFrom = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'derivedFrom'), 'derivedFrom', '__httpns_dataone_orgservicetypes0_6_2_SystemMetadata_derivedFrom', True)
    ...
    __size = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'size'), 'size', '__httpns_dataone_orgservicetypes0_6_2_SystemMetadata_size', False)
    ...
    __replica = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'replica'), 'replica', '__httpns_dataone_orgservicetypes0_6_2_SystemMetadata_replica', True)
    ...
    __describes = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'describes'), 'describes', '__httpns_dataone_orgservicetypes0_6_2_SystemMetadata_describes', True)
    ...
    __submitter = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'submitter'), 'submitter', '__httpns_dataone_orgservicetypes0_6_2_SystemMetadata_submitter', False)
    ...
    __describedBy = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'describedBy'), 'describedBy', '__httpns_dataone_orgservicetypes0_6_2_SystemMetadata_describedBy', True)
    ...
    __obsoletes = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'obsoletes'), 'obsoletes', '__httpns_dataone_orgservicetypes0_6_2_SystemMetadata_obsoletes', True)
    ...
    __rightsHolder = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'rightsHolder'), 'rightsHolder', '__httpns_dataone_orgservicetypes0_6_2_SystemMetadata_rightsHolder', False)
...
class Person (pyxb.binding.basis.complexTypeDefinition):
    ...
    __familyName = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'familyName'), 'familyName', '__httpns_dataone_orgservicetypes0_6_2_Person_familyName', False)
    ...
    __subject = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'subject'), 'subject', '__httpns_dataone_orgservicetypes0_6_2_Person_subject', False)
    ...
    __givenName = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'givenName'), 'givenName', '__httpns_dataone_orgservicetypes0_6_2_Person_givenName', True)
    ...
    __isMemberOf = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'isMemberOf'), 'isMemberOf', '__httpns_dataone_orgservicetypes0_6_2_Person_isMemberOf', True)
    ...
    __equivalentIdentity = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'equivalentIdentity'), 'equivalentIdentity', '__httpns_dataone_orgservicetypes0_6_2_Person_equivalentIdentity', True)
    ...
    __email = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'email'), 'email', '__httpns_dataone_orgservicetypes0_6_2_Person_email', True)
...
class Ping (pyxb.binding.basis.complexTypeDefinition):
    ...
    __lastSuccess = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'lastSuccess'), 'lastSuccess', '__httpns_dataone_orgservicetypes0_6_2_Ping_lastSuccess', pyxb.binding.datatypes.dateTime)
    
    lastSuccess = property(__lastSuccess.value, __lastSuccess.set, None, None)

    
    # Attribute success uses Python identifier success
    __success = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'success'), 'success', '__httpns_dataone_orgservicetypes0_6_2_Ping_success', pyxb.binding.datatypes.boolean)
...
class Node (pyxb.binding.basis.complexTypeDefinition):
    ...
    __name = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpns_dataone_orgservicetypes0_6_2_Node_name', False)
    ...
    __services = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'services'), 'services', '__httpns_dataone_orgservicetypes0_6_2_Node_services', False)
    ...
    __baseURL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'baseURL'), 'baseURL', '__httpns_dataone_orgservicetypes0_6_2_Node_baseURL', False)
    ...
    __description = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'description'), 'description', '__httpns_dataone_orgservicetypes0_6_2_Node_description', False)
    ...
    __synchronization = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'synchronization'), 'synchronization', '__httpns_dataone_orgservicetypes0_6_2_Node_synchronization', False)
    ...
    __health = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'health'), 'health', '__httpns_dataone_orgservicetypes0_6_2_Node_health', False)
    ...
    # Element identifier uses Python identifier identifier
    __identifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'identifier'), 'identifier', '__httpns_dataone_orgservicetypes0_6_2_Node_identifier', False)
    ...
    __synchronize = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'synchronize'), 'synchronize', '__httpns_dataone_orgservicetypes0_6_2_Node_synchronize', pyxb.binding.datatypes.boolean, required=True)
    
    synchronize = property(__synchronize.value, __synchronize.set, None, None)

    
    # Attribute replicate uses Python identifier replicate
    __replicate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'replicate'), 'replicate', '__httpns_dataone_orgservicetypes0_6_2_Node_replicate', pyxb.binding.datatypes.boolean, required=True)
    
    replicate = property(__replicate.value, __replicate.set, None, None)

    
    # Attribute type uses Python identifier type
    __type = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'type'), 'type', '__httpns_dataone_orgservicetypes0_6_2_Node_type', NodeType, required=True)
...
class AccessRule (pyxb.binding.basis.complexTypeDefinition):
    ...
    __permission = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'permission'), 'permission', '__httpns_dataone_orgservicetypes0_6_2_AccessRule_permission', True)
    ...
    # Element subject uses Python identifier subject
    __subject = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'subject'), 'subject', '__httpns_dataone_orgservicetypes0_6_2_AccessRule_subject', True)
...
class Checksum (pyxb.binding.basis.complexTypeDefinition):
    ...
    __algorithm = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'algorithm'), 'algorithm', '__httpns_dataone_orgservicetypes0_6_2_Checksum_algorithm', ChecksumAlgorithm, required=True)
...
class MonitorList (pyxb.binding.basis.complexTypeDefinition):
    ...
    __monitorInfo = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'monitorInfo'), 'monitorInfo', '__httpns_dataone_orgservicetypes0_6_2_MonitorList_monitorInfo', True)
...
class ObjectInfo (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element size uses Python identifier size
    __size = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'size'), 'size', '__httpns_dataone_orgservicetypes0_6_2_ObjectInfo_size', False)
    ...
    # Element identifier uses Python identifier identifier
    __identifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'identifier'), 'identifier', '__httpns_dataone_orgservicetypes0_6_2_ObjectInfo_identifier', False)
    ...
    # Element dateSysMetadataModified uses Python identifier dateSysMetadataModified
    __dateSysMetadataModified = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'dateSysMetadataModified'), 'dateSysMetadataModified', '__httpns_dataone_orgservicetypes0_6_2_ObjectInfo_dateSysMetadataModified', False)
    ...
    # Element checksum uses Python identifier checksum
    __checksum = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'checksum'), 'checksum', '__httpns_dataone_orgservicetypes0_6_2_ObjectInfo_checksum', False)
    ...
    # Element objectFormat uses Python identifier objectFormat
    __objectFormat = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'objectFormat'), 'objectFormat', '__httpns_dataone_orgservicetypes0_6_2_ObjectInfo_objectFormat', False)
...
class ObjectFormat (pyxb.binding.basis.complexTypeDefinition):
    ...
    __scienceMetadata = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'scienceMetadata'), 'scienceMetadata', '__httpns_dataone_orgservicetypes0_6_2_ObjectFormat_scienceMetadata', False)
    ...
    __fmtid = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'fmtid'), 'fmtid', '__httpns_dataone_orgservicetypes0_6_2_ObjectFormat_fmtid', False)
    ...
    __formatName = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'formatName'), 'formatName', '__httpns_dataone_orgservicetypes0_6_2_ObjectFormat_formatName', False)
...
class Services (pyxb.binding.basis.complexTypeDefinition):
    ...
    __service = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'service'), 'service', '__httpns_dataone_orgservicetypes0_6_2_Services_service', True)
...
class SubjectList (pyxb.binding.basis.complexTypeDefinition):
    ...
    __group = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'group'), 'group', '__httpns_dataone_orgservicetypes0_6_2_SubjectList_group', True)
    ...
    __person = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'person'), 'person', '__httpns_dataone_orgservicetypes0_6_2_SubjectList_person', True)
...
class NodeHealth (pyxb.binding.basis.complexTypeDefinition):
    ...
    __status = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'status'), 'status', '__httpns_dataone_orgservicetypes0_6_2_NodeHealth_status', False)
    ...
    __ping = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'ping'), 'ping', '__httpns_dataone_orgservicetypes0_6_2_NodeHealth_ping', False)
    ...
    __state = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'state'), 'state', '__httpns_dataone_orgservicetypes0_6_2_NodeHealth_state', NodeState, required=True)
...
class Component (pyxb.binding.basis.complexTypeDefinition):
    ...
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'version'), 'version', '__httpns_dataone_orgservicetypes0_6_2_Component_version', ComponentVersion, required=True)
    
    version = property(__version.value, __version.set, None, None)

    
    # Attribute name uses Python identifier name
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpns_dataone_orgservicetypes0_6_2_Component_name', ComponentName, required=True)
...
class Service (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element name uses Python identifier name
    __name = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpns_dataone_orgservicetypes0_6_2_Service_name', False)
    ...
    __available = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'available'), 'available', '__httpns_dataone_orgservicetypes0_6_2_Service_available', pyxb.binding.datatypes.boolean)
    
    available = property(__available.value, __available.set, None, None)

    
    # Attribute version uses Python identifier version
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'version'), 'version', '__httpns_dataone_orgservicetypes0_6_2_Service_version', ServiceVersion, required=True)
...
class AccessPolicy (pyxb.binding.basis.complexTypeDefinition):
    ...
    __allow = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'allow'), 'allow', '__httpns_dataone_orgservicetypes0_6_2_AccessPolicy_allow', True)
...
class ObjectLocation (pyxb.binding.basis.complexTypeDefinition):
    ...
    __preference = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'preference'), 'preference', '__httpns_dataone_orgservicetypes0_6_2_ObjectLocation_preference', False)
    ...
    __nodeIdentifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'nodeIdentifier'), 'nodeIdentifier', '__httpns_dataone_orgservicetypes0_6_2_ObjectLocation_nodeIdentifier', False)
    ...
    __url = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'url'), 'url', '__httpns_dataone_orgservicetypes0_6_2_ObjectLocation_url', False)
    ...
    # Element baseURL uses Python identifier baseURL
    __baseURL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'baseURL'), 'baseURL', '__httpns_dataone_orgservicetypes0_6_2_ObjectLocation_baseURL', False)
...
class Log (Slice):
    ...
    __logEntry = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'logEntry'), 'logEntry', '__httpns_dataone_orgservicetypes0_6_2_Log_logEntry', True)
...
class Schedule (pyxb.binding.basis.complexTypeDefinition):
    ...
    __hour = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'hour'), 'hour', '__httpns_dataone_orgservicetypes0_6_2_Schedule_hour', CrontabEntry, required=True)
    
    hour = property(__hour.value, __hour.set, None, None)

    
    # Attribute min uses Python identifier min
    __min = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'min'), 'min', '__httpns_dataone_orgservicetypes0_6_2_Schedule_min', CrontabEntry, required=True)
    
    min = property(__min.value, __min.set, None, None)

    
    # Attribute mday uses Python identifier mday
    __mday = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'mday'), 'mday', '__httpns_dataone_orgservicetypes0_6_2_Schedule_mday', CrontabEntry, required=True)
    
    mday = property(__mday.value, __mday.set, None, None)

    
    # Attribute mon uses Python identifier mon
    __mon = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'mon'), 'mon', '__httpns_dataone_orgservicetypes0_6_2_Schedule_mon', CrontabEntry, required=True)
    
    mon = property(__mon.value, __mon.set, None, None)

    
    # Attribute sec uses Python identifier sec
    __sec = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'sec'), 'sec', '__httpns_dataone_orgservicetypes0_6_2_Schedule_sec', CrontabEntry, required=True)
    
    sec = property(__sec.value, __sec.set, None, None)

    
    # Attribute wday uses Python identifier wday
    __wday = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'wday'), 'wday', '__httpns_dataone_orgservicetypes0_6_2_Schedule_wday', CrontabEntry, required=True)
    
    wday = property(__wday.value, __wday.set, None, None)

    
    # Attribute year uses Python identifier year
    __year = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'year'), 'year', '__httpns_dataone_orgservicetypes0_6_2_Schedule_year', CrontabEntry, required=True)
...
class ObjectLocationList (pyxb.binding.basis.complexTypeDefinition):
    ...
    __objectLocation = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'objectLocation'), 'objectLocation', '__httpns_dataone_orgservicetypes0_6_2_ObjectLocationList_objectLocation', True)
    ...
    # Element identifier uses Python identifier identifier
    __identifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'identifier'), 'identifier', '__httpns_dataone_orgservicetypes0_6_2_ObjectLocationList_identifier', False)
...
class Group (pyxb.binding.basis.complexTypeDefinition):
    ...
    __hasMember = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'hasMember'), 'hasMember', '__httpns_dataone_orgservicetypes0_6_2_Group_hasMember', True)
    ...
    # Element subject uses Python identifier subject
    __subject = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'subject'), 'subject', '__httpns_dataone_orgservicetypes0_6_2_Group_subject', False)
    ...
    __groupName = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'groupName'), 'groupName', '__httpns_dataone_orgservicetypes0_6_2_Group_groupName', False)
...
class Status (pyxb.binding.basis.complexTypeDefinition):
    ...
    __dateChecked = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'dateChecked'), 'dateChecked', '__httpns_dataone_orgservicetypes0_6_2_Status_dateChecked', pyxb.binding.datatypes.dateTime, required=True)
    
    dateChecked = property(__dateChecked.value, __dateChecked.set, None, None)

    
    # Attribute success uses Python identifier success
    __success = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'success'), 'success', '__httpns_dataone_orgservicetypes0_6_2_Status_success', pyxb.binding.datatypes.boolean)
...
class ReplicationPolicy (pyxb.binding.basis.complexTypeDefinition):
    ...
    __blockedMemberNode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'blockedMemberNode'), 'blockedMemberNode', '__httpns_dataone_orgservicetypes0_6_2_ReplicationPolicy_blockedMemberNode', True)
    ...
    __preferredMemberNode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'preferredMemberNode'), 'preferredMemberNode', '__httpns_dataone_orgservicetypes0_6_2_ReplicationPolicy_preferredMemberNode', True)
    ...
    __replicationAllowed = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'replicationAllowed'), 'replicationAllowed', '__httpns_dataone_orgservicetypes0_6_2_ReplicationPolicy_replicationAllowed', pyxb.binding.datatypes.boolean)
    ...
    __numberReplicas = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'numberReplicas'), 'numberReplicas', '__httpns_dataone_orgservicetypes0_6_2_ReplicationPolicy_numberReplicas', pyxb.binding.datatypes.int)
...
class Session (pyxb.binding.basis.complexTypeDefinition):
    ...
    __subjectList = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'subjectList'), 'subjectList', '__httpns_dataone_orgservicetypes0_6_2_Session_subjectList', False)
    ...
    # Element subject uses Python identifier subject
    __subject = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'subject'), 'subject', '__httpns_dataone_orgservicetypes0_6_2_Session_subject', False)
...
class ObjectList (Slice):
    ...
    __objectInfo = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'objectInfo'), 'objectInfo', '__httpns_dataone_orgservicetypes0_6_2_ObjectList_objectInfo', True)
...
class Synchronization (pyxb.binding.basis.complexTypeDefinition):
    ...
    __lastCompleteHarvest = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'lastCompleteHarvest'), 'lastCompleteHarvest', '__httpns_dataone_orgservicetypes0_6_2_Synchronization_lastCompleteHarvest', False)
    ...
    __schedule = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'schedule'), 'schedule', '__httpns_dataone_orgservicetypes0_6_2_Synchronization_schedule', False)
    ...
    __lastHarvested = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'lastHarvested'), 'lastHarvested', '__httpns_dataone_orgservicetypes0_6_2_Synchronization_lastHarvested', False)
...
class LogEntry (pyxb.binding.basis.complexTypeDefinition):
    ...
    __entryId = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'entryId'), 'entryId', '__httpns_dataone_orgservicetypes0_6_2_LogEntry_entryId', False)
    ...
    __dateLogged = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'dateLogged'), 'dateLogged', '__httpns_dataone_orgservicetypes0_6_2_LogEntry_dateLogged', False)
    ...
    __memberNode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'memberNode'), 'memberNode', '__httpns_dataone_orgservicetypes0_6_2_LogEntry_memberNode', False)
    ...
    __event = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'event'), 'event', '__httpns_dataone_orgservicetypes0_6_2_LogEntry_event', False)
    ...
    __ipAddress = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'ipAddress'), 'ipAddress', '__httpns_dataone_orgservicetypes0_6_2_LogEntry_ipAddress', False)
    ...
    # Element identifier uses Python identifier identifier
    __identifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'identifier'), 'identifier', '__httpns_dataone_orgservicetypes0_6_2_LogEntry_identifier', False)
    ...
    __userAgent = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'userAgent'), 'userAgent', '__httpns_dataone_orgservicetypes0_6_2_LogEntry_userAgent', False)
    ...
    # Element subject uses Python identifier subject
    __subject = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'subject'), 'subject', '__httpns_dataone_orgservicetypes0_6_2_LogEntry_subject', False)
...
class MonitorInfo (pyxb.binding.basis.complexTypeDefinition):
    ...
    __count = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'count'), 'count', '__httpns_dataone_orgservicetypes0_6_2_MonitorInfo_count', False)
    ...
    __date = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'date'), 'date', '__httpns_dataone_orgservicetypes0_6_2_MonitorInfo_date', False)
...
class Replica (pyxb.binding.basis.complexTypeDefinition):
    ...
    __replicaVerified = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'replicaVerified'), 'replicaVerified', '__httpns_dataone_orgservicetypes0_6_2_Replica_replicaVerified', False)
    ...
    __replicaMemberNode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'replicaMemberNode'), 'replicaMemberNode', '__httpns_dataone_orgservicetypes0_6_2_Replica_replicaMemberNode', False)
    ...
    __replicationStatus = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'replicationStatus'), 'replicationStatus', '__httpns_dataone_orgservicetypes0_6_2_Replica_replicationStatus', False)
