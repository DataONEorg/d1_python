...
# Generated 2011-10-25 19:38:43.599796 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:3d122ee6-ff73-11e0-805d-000c294230b4')
...
class Person (pyxb.binding.basis.complexTypeDefinition):
    ...
    equivalentIdentity = property(__equivalentIdentity.value, __equivalentIdentity.set, None, u'An alternative but equivalent identity for the principal that has been\n                        used in alternate identity systems.')
    ...
    isMemberOf = property(__isMemberOf.value, __isMemberOf.set, None, u'A group or role in which the Principal is a member, expressed using the\n                        unique Principal identifier for that group.')
...
Node._GroupModel = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(Node._UseForTag(pyxb.namespace.ExpandedName(None, u'contactSubject')), min_occurs=0L, max_occurs=None)
    )
Node._ContentModel = pyxb.binding.content.ParticleModel(Node._GroupModel, min_occurs=1, max_occurs=1)



Person._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'equivalentIdentity'), Subject, scope=Person, documentation=u'An alternative but equivalent identity for the principal that has been\n                        used in alternate identity systems.'))
...
Person._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'isMemberOf'), Subject, scope=Person, documentation=u'A group or role in which the Principal is a member, expressed using the\n                        unique Principal identifier for that group.'))
...
ObjectInfo._GroupModel = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(ObjectInfo._UseForTag(pyxb.namespace.ExpandedName(None, u'fmtid')), min_occurs=1, max_occurs=1),
...
SystemMetadata._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'serialVersion'), pyxb.binding.datatypes.long, scope=SystemMetadata))
...
SystemMetadata._GroupModel = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(SystemMetadata._UseForTag(pyxb.namespace.ExpandedName(None, u'fmtid')), min_occurs=1, max_occurs=1),
