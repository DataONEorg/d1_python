...
# NSM:6fce526037f4121d166b7e6d1e224bad618ea434
# Generated 2011-05-13 09:15:20.958580 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:d1412ff4-7d73-11e0-b556-000c29f765e9')

# Import bindings for namespaces imported into schema
import pyxb.binding.datatypes

Namespace = pyxb.namespace.NamespaceForURI(u'http://ns.dataone.org/service/types/0.6.1', create_if_missing=True)
...
class Principal (NonEmptyString):
  ...
  constraints as the Identifier.Used by :mod:`SystemMetadata`"""
    ...
    _Documentation = u'Person (user), Group, or Organization, or System.The formal name identifiying a user or group from the DataONE \n  Identity Management Service. The principal is represented by a unique,\n  persistent, non-reassignable identifier string that follows the same\n  constraints as the Identifier.Used by :mod:`SystemMetadata`'
...
class NodeReference (NonEmptyString):
    ...
    _Documentation = u'Member Node identifier drawn from the DataONE :mod:`cn_register <registry service>`.'
...
# Atomic SimpleTypeDefinition
class X509Certificate (NonEmptyString):

    """An atomic simple type."""

    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'X509Certificate')
    _Documentation = None
X509Certificate._InitializeFacetMap()
Namespace.addCategoryObject('typeBinding', u'X509Certificate', X509Certificate)
...
class Synchronization (pyxb.binding.basis.complexTypeDefinition):
    ...
    __lastCompleteHarvest = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'lastCompleteHarvest'), 'lastCompleteHarvest', '__httpns_dataone_orgservicetypes0_6_1_Synchronization_lastCompleteHarvest', False)
    ...
    __schedule = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'schedule'), 'schedule', '__httpns_dataone_orgservicetypes0_6_1_Synchronization_schedule', False)
    ...
    __lastHarvested = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'lastHarvested'), 'lastHarvested', '__httpns_dataone_orgservicetypes0_6_1_Synchronization_lastHarvested', False)
...
class Service (pyxb.binding.basis.complexTypeDefinition):
    ...
    __method = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'method'), 'method', '__httpns_dataone_orgservicetypes0_6_1_Service_method', True)
    ...
    __name = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpns_dataone_orgservicetypes0_6_1_Service_name', False)
    ...
    __available = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'available'), 'available', '__httpns_dataone_orgservicetypes0_6_1_Service_available', pyxb.binding.datatypes.boolean)
    
    available = property(__available.value, __available.set, None, None)

    
    # Attribute version uses Python identifier version
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'version'), 'version', '__httpns_dataone_orgservicetypes0_6_1_Service_version', ServiceVersion, required=True)
...
class AccessPolicy (pyxb.binding.basis.complexTypeDefinition):
    ...
    __allow = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'allow'), 'allow', '__httpns_dataone_orgservicetypes0_6_1_AccessPolicy_allow', True)
...
class Checksum (pyxb.binding.basis.complexTypeDefinition):
    ...
    __algorithm = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'algorithm'), 'algorithm', '__httpns_dataone_orgservicetypes0_6_1_Checksum_algorithm', ChecksumAlgorithm, required=True)
...
class ObjectInfo (pyxb.binding.basis.complexTypeDefinition):
    ...
    __size = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'size'), 'size', '__httpns_dataone_orgservicetypes0_6_1_ObjectInfo_size', False)
    ...
    __identifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'identifier'), 'identifier', '__httpns_dataone_orgservicetypes0_6_1_ObjectInfo_identifier', False)
    ...
    __dateSysMetadataModified = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'dateSysMetadataModified'), 'dateSysMetadataModified', '__httpns_dataone_orgservicetypes0_6_1_ObjectInfo_dateSysMetadataModified', False)
    ...
    __objectFormat = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'objectFormat'), 'objectFormat', '__httpns_dataone_orgservicetypes0_6_1_ObjectInfo_objectFormat', False)
    ...
    __checksum = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'checksum'), 'checksum', '__httpns_dataone_orgservicetypes0_6_1_ObjectInfo_checksum', False)
...
class LogEntry (pyxb.binding.basis.complexTypeDefinition):
    ...
    __entryId = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'entryId'), 'entryId', '__httpns_dataone_orgservicetypes0_6_1_LogEntry_entryId', False)
    ...
    # Element identifier uses Python identifier identifier
    __identifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'identifier'), 'identifier', '__httpns_dataone_orgservicetypes0_6_1_LogEntry_identifier', False)
    ...
    __userAgent = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'userAgent'), 'userAgent', '__httpns_dataone_orgservicetypes0_6_1_LogEntry_userAgent', False)
    ...
    __ipAddress = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'ipAddress'), 'ipAddress', '__httpns_dataone_orgservicetypes0_6_1_LogEntry_ipAddress', False)
    ...
    __principal = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'principal'), 'principal', '__httpns_dataone_orgservicetypes0_6_1_LogEntry_principal', False)
    ...
    __event = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'event'), 'event', '__httpns_dataone_orgservicetypes0_6_1_LogEntry_event', False)
    ...
    __dateLogged = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'dateLogged'), 'dateLogged', '__httpns_dataone_orgservicetypes0_6_1_LogEntry_dateLogged', False)
    ...
    __memberNode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'memberNode'), 'memberNode', '__httpns_dataone_orgservicetypes0_6_1_LogEntry_memberNode', False)
...
class SystemMetadata (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element checksum uses Python identifier checksum
    __checksum = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'checksum'), 'checksum', '__httpns_dataone_orgservicetypes0_6_1_SystemMetadata_checksum', False)
    ...
    __describedBy = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'describedBy'), 'describedBy', '__httpns_dataone_orgservicetypes0_6_1_SystemMetadata_describedBy', True)
    ...
    __describes = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'describes'), 'describes', '__httpns_dataone_orgservicetypes0_6_1_SystemMetadata_describes', True)
    ...
    __derivedFrom = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'derivedFrom'), 'derivedFrom', '__httpns_dataone_orgservicetypes0_6_1_SystemMetadata_derivedFrom', True)
    ...
    __submitter = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'submitter'), 'submitter', '__httpns_dataone_orgservicetypes0_6_1_SystemMetadata_submitter', False)
    ...
    # Element dateSysMetadataModified uses Python identifier dateSysMetadataModified
    __dateSysMetadataModified = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'dateSysMetadataModified'), 'dateSysMetadataModified', '__httpns_dataone_orgservicetypes0_6_1_SystemMetadata_dateSysMetadataModified', False)
    ...
    __rightsHolder = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'rightsHolder'), 'rightsHolder', '__httpns_dataone_orgservicetypes0_6_1_SystemMetadata_rightsHolder', False)
    ...
    # Element objectFormat uses Python identifier objectFormat
    __objectFormat = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'objectFormat'), 'objectFormat', '__httpns_dataone_orgservicetypes0_6_1_SystemMetadata_objectFormat', False)
    ...
    __authoritativeMemberNode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'authoritativeMemberNode'), 'authoritativeMemberNode', '__httpns_dataone_orgservicetypes0_6_1_SystemMetadata_authoritativeMemberNode', False)
    ...
    # Element identifier uses Python identifier identifier
    __identifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'identifier'), 'identifier', '__httpns_dataone_orgservicetypes0_6_1_SystemMetadata_identifier', False)
    ...
    __obsoletedBy = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'obsoletedBy'), 'obsoletedBy', '__httpns_dataone_orgservicetypes0_6_1_SystemMetadata_obsoletedBy', True)
    ...
    __replicationPolicy = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'replicationPolicy'), 'replicationPolicy', '__httpns_dataone_orgservicetypes0_6_1_SystemMetadata_replicationPolicy', False)
    ...
    __dateUploaded = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'dateUploaded'), 'dateUploaded', '__httpns_dataone_orgservicetypes0_6_1_SystemMetadata_dateUploaded', False)
    ...
    __accessPolicy = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'accessPolicy'), 'accessPolicy', '__httpns_dataone_orgservicetypes0_6_1_SystemMetadata_accessPolicy', False)
    ...
    __embargoExpires = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'embargoExpires'), 'embargoExpires', '__httpns_dataone_orgservicetypes0_6_1_SystemMetadata_embargoExpires', False)
    ...
    # Element size uses Python identifier size
    __size = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'size'), 'size', '__httpns_dataone_orgservicetypes0_6_1_SystemMetadata_size', False)
    ...
    __replica = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'replica'), 'replica', '__httpns_dataone_orgservicetypes0_6_1_SystemMetadata_replica', True)
    ...
    __originMemberNode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'originMemberNode'), 'originMemberNode', '__httpns_dataone_orgservicetypes0_6_1_SystemMetadata_originMemberNode', False)
    ...
    __obsoletes = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'obsoletes'), 'obsoletes', '__httpns_dataone_orgservicetypes0_6_1_SystemMetadata_obsoletes', True)
...
class ObjectLocation (pyxb.binding.basis.complexTypeDefinition):
    ...
    __preference = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'preference'), 'preference', '__httpns_dataone_orgservicetypes0_6_1_ObjectLocation_preference', False)
    ...
    __nodeIdentifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'nodeIdentifier'), 'nodeIdentifier', '__httpns_dataone_orgservicetypes0_6_1_ObjectLocation_nodeIdentifier', False)
    ...
    __url = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'url'), 'url', '__httpns_dataone_orgservicetypes0_6_1_ObjectLocation_url', False)
    ...
    __baseURL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'baseURL'), 'baseURL', '__httpns_dataone_orgservicetypes0_6_1_ObjectLocation_baseURL', False)
...
class Ping (pyxb.binding.basis.complexTypeDefinition):
    ...
    __lastSuccess = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'lastSuccess'), 'lastSuccess', '__httpns_dataone_orgservicetypes0_6_1_Ping_lastSuccess', pyxb.binding.datatypes.dateTime)
    
    lastSuccess = property(__lastSuccess.value, __lastSuccess.set, None, None)

    
    # Attribute success uses Python identifier success
    __success = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'success'), 'success', '__httpns_dataone_orgservicetypes0_6_1_Ping_success', pyxb.binding.datatypes.boolean)
...
class Node (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element baseURL uses Python identifier baseURL
    __baseURL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'baseURL'), 'baseURL', '__httpns_dataone_orgservicetypes0_6_1_Node_baseURL', False)
    ...
    __services = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'services'), 'services', '__httpns_dataone_orgservicetypes0_6_1_Node_services', False)
    ...
    __synchronization = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'synchronization'), 'synchronization', '__httpns_dataone_orgservicetypes0_6_1_Node_synchronization', False)
    ...
    __health = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'health'), 'health', '__httpns_dataone_orgservicetypes0_6_1_Node_health', False)
    ...
    # Element identifier uses Python identifier identifier
    __identifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'identifier'), 'identifier', '__httpns_dataone_orgservicetypes0_6_1_Node_identifier', False)
    ...
    # Element name uses Python identifier name
    __name = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpns_dataone_orgservicetypes0_6_1_Node_name', False)
    ...
    __description = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'description'), 'description', '__httpns_dataone_orgservicetypes0_6_1_Node_description', False)
    ...
    __environment = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'environment'), 'environment', '__httpns_dataone_orgservicetypes0_6_1_Node_environment', Environment)
    ...
    __synchronize = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'synchronize'), 'synchronize', '__httpns_dataone_orgservicetypes0_6_1_Node_synchronize', pyxb.binding.datatypes.boolean, required=True)
    
    synchronize = property(__synchronize.value, __synchronize.set, None, None)

    
    # Attribute type uses Python identifier type
    __type = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'type'), 'type', '__httpns_dataone_orgservicetypes0_6_1_Node_type', NodeType, required=True)
    
    type = property(__type.value, __type.set, None, None)

    
    # Attribute replicate uses Python identifier replicate
    __replicate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'replicate'), 'replicate', '__httpns_dataone_orgservicetypes0_6_1_Node_replicate', pyxb.binding.datatypes.boolean, required=True)
...
class Slice (pyxb.binding.basis.complexTypeDefinition):
    ...
    __count = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'count'), 'count', '__httpns_dataone_orgservicetypes0_6_1_Slice_count', pyxb.binding.datatypes.int, required=True)
    
    count = property(__count.value, __count.set, None, None)

    
    # Attribute start uses Python identifier start
    __start = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'start'), 'start', '__httpns_dataone_orgservicetypes0_6_1_Slice_start', pyxb.binding.datatypes.int, required=True)
    
    start = property(__start.value, __start.set, None, None)

    
    # Attribute total uses Python identifier total
    __total = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'total'), 'total', '__httpns_dataone_orgservicetypes0_6_1_Slice_total', pyxb.binding.datatypes.int, required=True)
...
class CTD_ANON (Slice):
    ...
    __logEntry = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'logEntry'), 'logEntry', '__httpns_dataone_orgservicetypes0_6_1_CTD_ANON_logEntry', True)

    
    logEntry = property(__logEntry.value, __logEntry.set, None, None)

    
    # Attribute count inherited from {http://ns.dataone.org/service/types/0.6.1}Slice
    
    # Attribute start inherited from {http://ns.dataone.org/service/types/0.6.1}Slice
    
    # Attribute total inherited from {http://ns.dataone.org/service/types/0.6.1}Slice
...
class ObjectList (Slice):
    ...
    __objectInfo = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'objectInfo'), 'objectInfo', '__httpns_dataone_orgservicetypes0_6_1_ObjectList_objectInfo', True)
...
class Schedule (pyxb.binding.basis.complexTypeDefinition):
    ...
    __hour = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'hour'), 'hour', '__httpns_dataone_orgservicetypes0_6_1_Schedule_hour', CrontabEntry, required=True)
    
    hour = property(__hour.value, __hour.set, None, None)

    
    # Attribute mon uses Python identifier mon
    __mon = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'mon'), 'mon', '__httpns_dataone_orgservicetypes0_6_1_Schedule_mon', CrontabEntry, required=True)
    
    mon = property(__mon.value, __mon.set, None, None)

    
    # Attribute min uses Python identifier min
    __min = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'min'), 'min', '__httpns_dataone_orgservicetypes0_6_1_Schedule_min', CrontabEntry, required=True)
    
    min = property(__min.value, __min.set, None, None)

    
    # Attribute mday uses Python identifier mday
    __mday = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'mday'), 'mday', '__httpns_dataone_orgservicetypes0_6_1_Schedule_mday', CrontabEntry, required=True)
    
    mday = property(__mday.value, __mday.set, None, None)

    
    # Attribute sec uses Python identifier sec
    __sec = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'sec'), 'sec', '__httpns_dataone_orgservicetypes0_6_1_Schedule_sec', CrontabEntry, required=True)
    
    sec = property(__sec.value, __sec.set, None, None)

    
    # Attribute wday uses Python identifier wday
    __wday = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'wday'), 'wday', '__httpns_dataone_orgservicetypes0_6_1_Schedule_wday', CrontabEntry, required=True)
    
    wday = property(__wday.value, __wday.set, None, None)

    
    # Attribute year uses Python identifier year
    __year = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'year'), 'year', '__httpns_dataone_orgservicetypes0_6_1_Schedule_year', CrontabEntry, required=True)
...
class Component (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute version uses Python identifier version
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'version'), 'version', '__httpns_dataone_orgservicetypes0_6_1_Component_version', ComponentVersion, required=True)
    
    version = property(__version.value, __version.set, None, None)

    
    # Attribute name uses Python identifier name
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpns_dataone_orgservicetypes0_6_1_Component_name', ComponentName, required=True)
...
# Complex type PrincipalList with content type ELEMENT_ONLY
class PrincipalList (pyxb.binding.basis.complexTypeDefinition):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'PrincipalList')
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element person uses Python identifier person
    __person = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'person'), 'person', '__httpns_dataone_orgservicetypes0_6_1_PrincipalList_person', True)
    ...
    __group = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'group'), 'group', '__httpns_dataone_orgservicetypes0_6_1_PrincipalList_group', True)
...
Namespace.addCategoryObject('typeBinding', u'PrincipalList', PrincipalList)
...
class Person (pyxb.binding.basis.complexTypeDefinition):
    ...
    __email = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'email'), 'email', '__httpns_dataone_orgservicetypes0_6_1_Person_email', True)
    ...
    __isMemberOf = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'isMemberOf'), 'isMemberOf', '__httpns_dataone_orgservicetypes0_6_1_Person_isMemberOf', True)
    ...
    __equivalentIdentity = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'equivalentIdentity'), 'equivalentIdentity', '__httpns_dataone_orgservicetypes0_6_1_Person_equivalentIdentity', True)
    ...
    # Element principal uses Python identifier principal
    __principal = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'principal'), 'principal', '__httpns_dataone_orgservicetypes0_6_1_Person_principal', False)
    ...
    __givenName = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'givenName'), 'givenName', '__httpns_dataone_orgservicetypes0_6_1_Person_givenName', True)
    ...
    __familyName = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'familyName'), 'familyName', '__httpns_dataone_orgservicetypes0_6_1_Person_familyName', False)
...
class ServiceMethod (pyxb.binding.basis.complexTypeDefinition):
    ...
    __implemented = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'implemented'), 'implemented', '__httpns_dataone_orgservicetypes0_6_1_ServiceMethod_implemented', pyxb.binding.datatypes.boolean, required=True)
    
    implemented = property(__implemented.value, __implemented.set, None, None)

    
    # Attribute name uses Python identifier name
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpns_dataone_orgservicetypes0_6_1_ServiceMethod_name', pyxb.binding.datatypes.NMTOKEN)
    
    name = property(__name.value, __name.set, None, None)

    
    # Attribute rest uses Python identifier rest
    __rest = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'rest'), 'rest', '__httpns_dataone_orgservicetypes0_6_1_ServiceMethod_rest', pyxb.binding.datatypes.token, required=True)
...
class Services (pyxb.binding.basis.complexTypeDefinition):
    ...
    __service = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'service'), 'service', '__httpns_dataone_orgservicetypes0_6_1_Services_service', True)
...
class NodeHealth (pyxb.binding.basis.complexTypeDefinition):
    ...
    __status = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'status'), 'status', '__httpns_dataone_orgservicetypes0_6_1_NodeHealth_status', False)
    ...
    __ping = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'ping'), 'ping', '__httpns_dataone_orgservicetypes0_6_1_NodeHealth_ping', False)
    ...
    __state = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'state'), 'state', '__httpns_dataone_orgservicetypes0_6_1_NodeHealth_state', NodeState, required=True)
...
class ReplicationPolicy (pyxb.binding.basis.complexTypeDefinition):
    ...
    __blockedMemberNode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'blockedMemberNode'), 'blockedMemberNode', '__httpns_dataone_orgservicetypes0_6_1_ReplicationPolicy_blockedMemberNode', True)
    ...
    __preferredMemberNode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'preferredMemberNode'), 'preferredMemberNode', '__httpns_dataone_orgservicetypes0_6_1_ReplicationPolicy_preferredMemberNode', True)
    ...
    __replicationAllowed = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'replicationAllowed'), 'replicationAllowed', '__httpns_dataone_orgservicetypes0_6_1_ReplicationPolicy_replicationAllowed', pyxb.binding.datatypes.boolean)
    ...
    __numberReplicas = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'numberReplicas'), 'numberReplicas', '__httpns_dataone_orgservicetypes0_6_1_ReplicationPolicy_numberReplicas', pyxb.binding.datatypes.int)
...
class MonitorInfo (pyxb.binding.basis.complexTypeDefinition):
    ...
    __count = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'count'), 'count', '__httpns_dataone_orgservicetypes0_6_1_MonitorInfo_count', False)
    ...
    __date = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'date'), 'date', '__httpns_dataone_orgservicetypes0_6_1_MonitorInfo_date', False)
...
class Replica (pyxb.binding.basis.complexTypeDefinition):
    ...
    __replicaVerified = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'replicaVerified'), 'replicaVerified', '__httpns_dataone_orgservicetypes0_6_1_Replica_replicaVerified', False)
    ...
    __replicaMemberNode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'replicaMemberNode'), 'replicaMemberNode', '__httpns_dataone_orgservicetypes0_6_1_Replica_replicaMemberNode', False)
    ...
    __replicationStatus = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'replicationStatus'), 'replicationStatus', '__httpns_dataone_orgservicetypes0_6_1_Replica_replicationStatus', False)
...
class AccessRule (pyxb.binding.basis.complexTypeDefinition):
    ...
    __resource = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'resource'), 'resource', '__httpns_dataone_orgservicetypes0_6_1_AccessRule_resource', True)
    ...
    # Element principal uses Python identifier principal
    __principal = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'principal'), 'principal', '__httpns_dataone_orgservicetypes0_6_1_AccessRule_principal', True)
    ...
    __permission = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'permission'), 'permission', '__httpns_dataone_orgservicetypes0_6_1_AccessRule_permission', True)
...
class NodeList (pyxb.binding.basis.complexTypeDefinition):
    ...
    __node = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'node'), 'node', '__httpns_dataone_orgservicetypes0_6_1_NodeList_node', True)
...
class ObjectLocationList (pyxb.binding.basis.complexTypeDefinition):
    ...
    __objectLocation = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'objectLocation'), 'objectLocation', '__httpns_dataone_orgservicetypes0_6_1_ObjectLocationList_objectLocation', True)
    ...
    # Element identifier uses Python identifier identifier
    __identifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'identifier'), 'identifier', '__httpns_dataone_orgservicetypes0_6_1_ObjectLocationList_identifier', False)
...
class Status (pyxb.binding.basis.complexTypeDefinition):
    ...
    __dateChecked = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'dateChecked'), 'dateChecked', '__httpns_dataone_orgservicetypes0_6_1_Status_dateChecked', pyxb.binding.datatypes.dateTime, required=True)
    
    dateChecked = property(__dateChecked.value, __dateChecked.set, None, None)

    
    # Attribute success uses Python identifier success
    __success = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'success'), 'success', '__httpns_dataone_orgservicetypes0_6_1_Status_success', pyxb.binding.datatypes.boolean)
...
class Group (pyxb.binding.basis.complexTypeDefinition):
    ...
    __hasMember = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'hasMember'), 'hasMember', '__httpns_dataone_orgservicetypes0_6_1_Group_hasMember', True)
    ...
    # Element principal uses Python identifier principal
    __principal = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'principal'), 'principal', '__httpns_dataone_orgservicetypes0_6_1_Group_principal', False)
    ...
    __groupName = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'groupName'), 'groupName', '__httpns_dataone_orgservicetypes0_6_1_Group_groupName', False)
...
class ComponentList (pyxb.binding.basis.complexTypeDefinition):
    ...
    __component = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'component'), 'component', '__httpns_dataone_orgservicetypes0_6_1_ComponentList_component', False)
...
# Complex type AuthToken with content type SIMPLE
class AuthToken (pyxb.binding.basis.complexTypeDefinition):
    _TypeDefinition = NonEmptyString
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_SIMPLE
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'AuthToken')
    # Base type is NonEmptyString
...
Namespace.addCategoryObject('typeBinding', u'AuthToken', AuthToken)
...
class MonitorList (pyxb.binding.basis.complexTypeDefinition):
    ...
    __monitorInfo = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'monitorInfo'), 'monitorInfo', '__httpns_dataone_orgservicetypes0_6_1_MonitorList_monitorInfo', True)
...
principal = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'principal'), Principal)
Namespace.addCategoryObject('elementBinding', principal.name().localName(), principal)
...
principalList = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'principalList'), PrincipalList)
Namespace.addCategoryObject('elementBinding', principalList.name().localName(), principalList)
...
permission = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'permission'), Permission)
...
PrincipalList._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'person'), Person, scope=PrincipalList))

PrincipalList._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'group'), Group, scope=PrincipalList))
PrincipalList._GroupModel = pyxb.binding.content.GroupChoice(
    pyxb.binding.content.ParticleModel(PrincipalList._UseForTag(pyxb.namespace.ExpandedName(None, u'person')), min_occurs=0L, max_occurs=None),
    pyxb.binding.content.ParticleModel(PrincipalList._UseForTag(pyxb.namespace.ExpandedName(None, u'group')), min_occurs=0L, max_occurs=None)
    )
PrincipalList._ContentModel = pyxb.binding.content.ParticleModel(PrincipalList._GroupModel, min_occurs=1, max_occurs=1)



Person._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'email'), NonEmptyString, scope=Person))

Person._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'isMemberOf'), Principal, scope=Person))

Person._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'equivalentIdentity'), Principal, scope=Person))

Person._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'principal'), Principal, scope=Person))
...
Person._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(Person._UseForTag(pyxb.namespace.ExpandedName(None, u'principal')), min_occurs=1L, max_occurs=1L),
...
AccessRule._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'resource'), Identifier, scope=AccessRule))

AccessRule._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'principal'), Principal, scope=AccessRule))
...
AccessRule._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(AccessRule._UseForTag(pyxb.namespace.ExpandedName(None, u'principal')), min_occurs=1L, max_occurs=None),
    ...
    pyxb.binding.content.ParticleModel(AccessRule._UseForTag(pyxb.namespace.ExpandedName(None, u'resource')), min_occurs=1L, max_occurs=None)
    )
...
Group._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'hasMember'), Principal, scope=Group))

Group._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'principal'), Principal, scope=Group))
...
Group._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(Group._UseForTag(pyxb.namespace.ExpandedName(None, u'principal')), min_occurs=1L, max_occurs=1L),
