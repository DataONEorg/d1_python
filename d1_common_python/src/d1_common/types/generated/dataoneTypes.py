...
# NSM:73edd6e38183823f97ff0d228187825299e30a71
# Generated 2011-01-13 23:04:41.246904 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:2c9d0da6-1fa4-11e0-bed6-000c29f765e9')

# Import bindings for namespaces imported into schema
import pyxb.binding.datatypes

Namespace = pyxb.namespace.NamespaceForURI(u'http://dataone.org/service/types/0.6.0', create_if_missing=True)
...
class Slice (pyxb.binding.basis.complexTypeDefinition):
    ...
    __count = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'count'), 'count', '__httpdataone_orgservicetypes0_6_0_Slice_count', pyxb.binding.datatypes.int, required=True)
    
    count = property(__count.value, __count.set, None, None)

    
    # Attribute start uses Python identifier start
    __start = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'start'), 'start', '__httpdataone_orgservicetypes0_6_0_Slice_start', pyxb.binding.datatypes.int, required=True)
    
    start = property(__start.value, __start.set, None, None)

    
    # Attribute total uses Python identifier total
    __total = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'total'), 'total', '__httpdataone_orgservicetypes0_6_0_Slice_total', pyxb.binding.datatypes.int, required=True)
...
class ObjectList (Slice):
    ...
    __objectInfo = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'objectInfo'), 'objectInfo', '__httpdataone_orgservicetypes0_6_0_ObjectList_objectInfo', True)

    
    objectInfo = property(__objectInfo.value, __objectInfo.set, None, None)

    
    # Attribute count inherited from {http://dataone.org/service/types/0.6.0}Slice
    
    # Attribute start inherited from {http://dataone.org/service/types/0.6.0}Slice
    
    # Attribute total inherited from {http://dataone.org/service/types/0.6.0}Slice
...
class NodeList (pyxb.binding.basis.complexTypeDefinition):
    ...
    __node = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'node'), 'node', '__httpdataone_orgservicetypes0_6_0_NodeList_node', True)
...
class ObjectLocation (pyxb.binding.basis.complexTypeDefinition):
    ...
    __preference = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'preference'), 'preference', '__httpdataone_orgservicetypes0_6_0_ObjectLocation_preference', False)
    ...
    __nodeIdentifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'nodeIdentifier'), 'nodeIdentifier', '__httpdataone_orgservicetypes0_6_0_ObjectLocation_nodeIdentifier', False)
    ...
    __url = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'url'), 'url', '__httpdataone_orgservicetypes0_6_0_ObjectLocation_url', False)
    ...
    __baseURL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'baseURL'), 'baseURL', '__httpdataone_orgservicetypes0_6_0_ObjectLocation_baseURL', False)
...
class LogEntry (pyxb.binding.basis.complexTypeDefinition):
    ...
    __ipAddress = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'ipAddress'), 'ipAddress', '__httpdataone_orgservicetypes0_6_0_LogEntry_ipAddress', False)
    ...
    __userAgent = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'userAgent'), 'userAgent', '__httpdataone_orgservicetypes0_6_0_LogEntry_userAgent', False)
    ...
    __dateLogged = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'dateLogged'), 'dateLogged', '__httpdataone_orgservicetypes0_6_0_LogEntry_dateLogged', False)
    ...
    __event = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'event'), 'event', '__httpdataone_orgservicetypes0_6_0_LogEntry_event', False)
    ...
    __principal = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'principal'), 'principal', '__httpdataone_orgservicetypes0_6_0_LogEntry_principal', False)
    ...
    __memberNode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'memberNode'), 'memberNode', '__httpdataone_orgservicetypes0_6_0_LogEntry_memberNode', False)
    ...
    __entryId = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'entryId'), 'entryId', '__httpdataone_orgservicetypes0_6_0_LogEntry_entryId', False)
    ...
    __identifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'identifier'), 'identifier', '__httpdataone_orgservicetypes0_6_0_LogEntry_identifier', False)
...
class Status (pyxb.binding.basis.complexTypeDefinition):
    ...
    __dateChecked = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'dateChecked'), 'dateChecked', '__httpdataone_orgservicetypes0_6_0_Status_dateChecked', pyxb.binding.datatypes.dateTime, required=True)
    
    dateChecked = property(__dateChecked.value, __dateChecked.set, None, None)

    
    # Attribute success uses Python identifier success
    __success = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'success'), 'success', '__httpdataone_orgservicetypes0_6_0_Status_success', pyxb.binding.datatypes.boolean)
...
class Services (pyxb.binding.basis.complexTypeDefinition):
    ...
    __service = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'service'), 'service', '__httpdataone_orgservicetypes0_6_0_Services_service', True)
...
class Checksum (pyxb.binding.basis.complexTypeDefinition):
    ...
    __algorithm = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'algorithm'), 'algorithm', '__httpdataone_orgservicetypes0_6_0_Checksum_algorithm', ChecksumAlgorithm, required=True)
...
class NodeHealth (pyxb.binding.basis.complexTypeDefinition):
    ...
    __status = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'status'), 'status', '__httpdataone_orgservicetypes0_6_0_NodeHealth_status', False)
    ...
    __ping = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'ping'), 'ping', '__httpdataone_orgservicetypes0_6_0_NodeHealth_ping', False)
    ...
    __state = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'state'), 'state', '__httpdataone_orgservicetypes0_6_0_NodeHealth_state', NodeState, required=True)
...
class Component (pyxb.binding.basis.complexTypeDefinition):
    ...
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'version'), 'version', '__httpdataone_orgservicetypes0_6_0_Component_version', ComponentVersion, required=True)
    
    version = property(__version.value, __version.set, None, None)

    
    # Attribute name uses Python identifier name
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpdataone_orgservicetypes0_6_0_Component_name', ComponentName, required=True)
...
class ObjectInfo (pyxb.binding.basis.complexTypeDefinition):
    ...
    __size = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'size'), 'size', '__httpdataone_orgservicetypes0_6_0_ObjectInfo_size', False)
    ...
    # Element identifier uses Python identifier identifier
    __identifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'identifier'), 'identifier', '__httpdataone_orgservicetypes0_6_0_ObjectInfo_identifier', False)
    ...
    __checksum = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'checksum'), 'checksum', '__httpdataone_orgservicetypes0_6_0_ObjectInfo_checksum', False)
    ...
    __dateSysMetadataModified = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'dateSysMetadataModified'), 'dateSysMetadataModified', '__httpdataone_orgservicetypes0_6_0_ObjectInfo_dateSysMetadataModified', False)
    ...
    __objectFormat = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'objectFormat'), 'objectFormat', '__httpdataone_orgservicetypes0_6_0_ObjectInfo_objectFormat', False)
...
class ReplicationPolicy (pyxb.binding.basis.complexTypeDefinition):
    ...
    __blockedMemberNode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'blockedMemberNode'), 'blockedMemberNode', '__httpdataone_orgservicetypes0_6_0_ReplicationPolicy_blockedMemberNode', True)
    ...
    __preferredMemberNode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'preferredMemberNode'), 'preferredMemberNode', '__httpdataone_orgservicetypes0_6_0_ReplicationPolicy_preferredMemberNode', True)
    ...
    __replicationAllowed = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'replicationAllowed'), 'replicationAllowed', '__httpdataone_orgservicetypes0_6_0_ReplicationPolicy_replicationAllowed', pyxb.binding.datatypes.boolean)
    ...
    __numberReplicas = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'numberReplicas'), 'numberReplicas', '__httpdataone_orgservicetypes0_6_0_ReplicationPolicy_numberReplicas', pyxb.binding.datatypes.int)
...
class Service (pyxb.binding.basis.complexTypeDefinition):
    ...
    __method = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'method'), 'method', '__httpdataone_orgservicetypes0_6_0_Service_method', True)
    ...
    __name = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpdataone_orgservicetypes0_6_0_Service_name', False)
    ...
    __available = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'available'), 'available', '__httpdataone_orgservicetypes0_6_0_Service_available', pyxb.binding.datatypes.boolean)
    
    available = property(__available.value, __available.set, None, None)

    
    # Attribute version uses Python identifier version
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'version'), 'version', '__httpdataone_orgservicetypes0_6_0_Service_version', ServiceVersion, required=True)
...
class Ping (pyxb.binding.basis.complexTypeDefinition):
    ...
    __lastSuccess = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'lastSuccess'), 'lastSuccess', '__httpdataone_orgservicetypes0_6_0_Ping_lastSuccess', pyxb.binding.datatypes.dateTime)
    
    lastSuccess = property(__lastSuccess.value, __lastSuccess.set, None, None)

    
    # Attribute success uses Python identifier success
    __success = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'success'), 'success', '__httpdataone_orgservicetypes0_6_0_Ping_success', pyxb.binding.datatypes.boolean)
...
class AccessPolicy (pyxb.binding.basis.complexTypeDefinition):
    ...
    __allow = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'allow'), 'allow', '__httpdataone_orgservicetypes0_6_0_AccessPolicy_allow', True)
...
class ComponentList (pyxb.binding.basis.complexTypeDefinition):
    ...
    __component = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'component'), 'component', '__httpdataone_orgservicetypes0_6_0_ComponentList_component', False)
...
class ObjectLocationList (pyxb.binding.basis.complexTypeDefinition):
    ...
    __objectLocation = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'objectLocation'), 'objectLocation', '__httpdataone_orgservicetypes0_6_0_ObjectLocationList_objectLocation', True)
    ...
    # Element identifier uses Python identifier identifier
    __identifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'identifier'), 'identifier', '__httpdataone_orgservicetypes0_6_0_ObjectLocationList_identifier', False)
...
class Schedule (pyxb.binding.basis.complexTypeDefinition):
    ...
    __min = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'min'), 'min', '__httpdataone_orgservicetypes0_6_0_Schedule_min', CrontabEntry, required=True)
    
    min = property(__min.value, __min.set, None, None)

    
    # Attribute hour uses Python identifier hour
    __hour = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'hour'), 'hour', '__httpdataone_orgservicetypes0_6_0_Schedule_hour', CrontabEntry, required=True)
    
    hour = property(__hour.value, __hour.set, None, None)

    
    # Attribute mon uses Python identifier mon
    __mon = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'mon'), 'mon', '__httpdataone_orgservicetypes0_6_0_Schedule_mon', CrontabEntry, required=True)
    
    mon = property(__mon.value, __mon.set, None, None)

    
    # Attribute sec uses Python identifier sec
    __sec = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'sec'), 'sec', '__httpdataone_orgservicetypes0_6_0_Schedule_sec', CrontabEntry, required=True)
    
    sec = property(__sec.value, __sec.set, None, None)

    
    # Attribute year uses Python identifier year
    __year = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'year'), 'year', '__httpdataone_orgservicetypes0_6_0_Schedule_year', CrontabEntry, required=True)
    
    year = property(__year.value, __year.set, None, None)

    
    # Attribute wday uses Python identifier wday
    __wday = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'wday'), 'wday', '__httpdataone_orgservicetypes0_6_0_Schedule_wday', CrontabEntry, required=True)
    
    wday = property(__wday.value, __wday.set, None, None)

    
    # Attribute mday uses Python identifier mday
    __mday = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'mday'), 'mday', '__httpdataone_orgservicetypes0_6_0_Schedule_mday', CrontabEntry, required=True)
...
class Replica (pyxb.binding.basis.complexTypeDefinition):
    ...
    __replicaVerified = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'replicaVerified'), 'replicaVerified', '__httpdataone_orgservicetypes0_6_0_Replica_replicaVerified', False)
    ...
    __replicaMemberNode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'replicaMemberNode'), 'replicaMemberNode', '__httpdataone_orgservicetypes0_6_0_Replica_replicaMemberNode', False)
    ...
    __replicationStatus = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'replicationStatus'), 'replicationStatus', '__httpdataone_orgservicetypes0_6_0_Replica_replicationStatus', False)
...
class MonitorList (pyxb.binding.basis.complexTypeDefinition):
    ...
    __monitorInfo = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'monitorInfo'), 'monitorInfo', '__httpdataone_orgservicetypes0_6_0_MonitorList_monitorInfo', True)
...
class Node (pyxb.binding.basis.complexTypeDefinition):
    ...
    __synchronization = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'synchronization'), 'synchronization', '__httpdataone_orgservicetypes0_6_0_Node_synchronization', False)
    ...
    __health = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'health'), 'health', '__httpdataone_orgservicetypes0_6_0_Node_health', False)
    ...
    # Element name uses Python identifier name
    __name = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpdataone_orgservicetypes0_6_0_Node_name', False)
    ...
    # Element identifier uses Python identifier identifier
    __identifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'identifier'), 'identifier', '__httpdataone_orgservicetypes0_6_0_Node_identifier', False)
    ...
    __description = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'description'), 'description', '__httpdataone_orgservicetypes0_6_0_Node_description', False)
    ...
    # Element baseURL uses Python identifier baseURL
    __baseURL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'baseURL'), 'baseURL', '__httpdataone_orgservicetypes0_6_0_Node_baseURL', False)
    ...
    __services = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'services'), 'services', '__httpdataone_orgservicetypes0_6_0_Node_services', False)
    ...
    __environment = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'environment'), 'environment', '__httpdataone_orgservicetypes0_6_0_Node_environment', Environment)
    ...
    __synchronize = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'synchronize'), 'synchronize', '__httpdataone_orgservicetypes0_6_0_Node_synchronize', pyxb.binding.datatypes.boolean, required=True)
    
    synchronize = property(__synchronize.value, __synchronize.set, None, None)

    
    # Attribute replicate uses Python identifier replicate
    __replicate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'replicate'), 'replicate', '__httpdataone_orgservicetypes0_6_0_Node_replicate', pyxb.binding.datatypes.boolean, required=True)
    
    replicate = property(__replicate.value, __replicate.set, None, None)

    
    # Attribute type uses Python identifier type
    __type = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'type'), 'type', '__httpdataone_orgservicetypes0_6_0_Node_type', NodeType, required=True)
...
class SystemMetadata (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element checksum uses Python identifier checksum
    __checksum = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'checksum'), 'checksum', '__httpdataone_orgservicetypes0_6_0_SystemMetadata_checksum', False)
    ...
    __replicationPolicy = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'replicationPolicy'), 'replicationPolicy', '__httpdataone_orgservicetypes0_6_0_SystemMetadata_replicationPolicy', False)
    ...
    __obsoletedBy = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'obsoletedBy'), 'obsoletedBy', '__httpdataone_orgservicetypes0_6_0_SystemMetadata_obsoletedBy', True)
    ...
    __originMemberNode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'originMemberNode'), 'originMemberNode', '__httpdataone_orgservicetypes0_6_0_SystemMetadata_originMemberNode', False)
    ...
    __embargoExpires = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'embargoExpires'), 'embargoExpires', '__httpdataone_orgservicetypes0_6_0_SystemMetadata_embargoExpires', False)
    ...
    __accessPolicy = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'accessPolicy'), 'accessPolicy', '__httpdataone_orgservicetypes0_6_0_SystemMetadata_accessPolicy', True)
    ...
    __dateUploaded = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'dateUploaded'), 'dateUploaded', '__httpdataone_orgservicetypes0_6_0_SystemMetadata_dateUploaded', False)
    ...
    __describes = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'describes'), 'describes', '__httpdataone_orgservicetypes0_6_0_SystemMetadata_describes', True)
    ...
    __replica = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'replica'), 'replica', '__httpdataone_orgservicetypes0_6_0_SystemMetadata_replica', True)
    ...
    __obsoletes = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'obsoletes'), 'obsoletes', '__httpdataone_orgservicetypes0_6_0_SystemMetadata_obsoletes', True)
    ...
    # Element dateSysMetadataModified uses Python identifier dateSysMetadataModified
    __dateSysMetadataModified = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'dateSysMetadataModified'), 'dateSysMetadataModified', '__httpdataone_orgservicetypes0_6_0_SystemMetadata_dateSysMetadataModified', False)
    ...
    __rightsHolder = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'rightsHolder'), 'rightsHolder', '__httpdataone_orgservicetypes0_6_0_SystemMetadata_rightsHolder', False)
    ...
    # Element identifier uses Python identifier identifier
    __identifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'identifier'), 'identifier', '__httpdataone_orgservicetypes0_6_0_SystemMetadata_identifier', False)
    ...
    __derivedFrom = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'derivedFrom'), 'derivedFrom', '__httpdataone_orgservicetypes0_6_0_SystemMetadata_derivedFrom', True)
    ...
    # Element objectFormat uses Python identifier objectFormat
    __objectFormat = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'objectFormat'), 'objectFormat', '__httpdataone_orgservicetypes0_6_0_SystemMetadata_objectFormat', False)
    ...
    __authoritativeMemberNode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'authoritativeMemberNode'), 'authoritativeMemberNode', '__httpdataone_orgservicetypes0_6_0_SystemMetadata_authoritativeMemberNode', False)
    ...
    # Element size uses Python identifier size
    __size = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'size'), 'size', '__httpdataone_orgservicetypes0_6_0_SystemMetadata_size', False)
    ...
    __describedBy = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'describedBy'), 'describedBy', '__httpdataone_orgservicetypes0_6_0_SystemMetadata_describedBy', True)
    ...
    __submitter = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'submitter'), 'submitter', '__httpdataone_orgservicetypes0_6_0_SystemMetadata_submitter', False)
...
class Synchronization (pyxb.binding.basis.complexTypeDefinition):
    ...
    __lastCompleteHarvest = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'lastCompleteHarvest'), 'lastCompleteHarvest', '__httpdataone_orgservicetypes0_6_0_Synchronization_lastCompleteHarvest', False)
    ...
    __schedule = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'schedule'), 'schedule', '__httpdataone_orgservicetypes0_6_0_Synchronization_schedule', False)
    ...
    __lastHarvested = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'lastHarvested'), 'lastHarvested', '__httpdataone_orgservicetypes0_6_0_Synchronization_lastHarvested', False)
...
class PrincipalList (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element principal uses Python identifier principal
    __principal = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'principal'), 'principal', '__httpdataone_orgservicetypes0_6_0_PrincipalList_principal', True)
...
class MonitorInfo (pyxb.binding.basis.complexTypeDefinition):
    ...
    __count = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'count'), 'count', '__httpdataone_orgservicetypes0_6_0_MonitorInfo_count', False)
    ...
    __date = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'date'), 'date', '__httpdataone_orgservicetypes0_6_0_MonitorInfo_date', False)
...
class ServiceMethod (pyxb.binding.basis.complexTypeDefinition):
    ...
    __implemented = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'implemented'), 'implemented', '__httpdataone_orgservicetypes0_6_0_ServiceMethod_implemented', pyxb.binding.datatypes.boolean, required=True)
    
    implemented = property(__implemented.value, __implemented.set, None, None)

    
    # Attribute name uses Python identifier name
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpdataone_orgservicetypes0_6_0_ServiceMethod_name', pyxb.binding.datatypes.NMTOKEN)
    
    name = property(__name.value, __name.set, None, None)

    
    # Attribute rest uses Python identifier rest
    __rest = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'rest'), 'rest', '__httpdataone_orgservicetypes0_6_0_ServiceMethod_rest', pyxb.binding.datatypes.token, required=True)
...
class AccessRule (pyxb.binding.basis.complexTypeDefinition):
    ...
    __resource = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'resource'), 'resource', '__httpdataone_orgservicetypes0_6_0_AccessRule_resource', True)
    ...
    # Element principal uses Python identifier principal
    __principal = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'principal'), 'principal', '__httpdataone_orgservicetypes0_6_0_AccessRule_principal', True)
    ...
    __permission = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'permission'), 'permission', '__httpdataone_orgservicetypes0_6_0_AccessRule_permission', True)
...
class CTD_ANON (Slice):
    ...
    __logEntry = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'logEntry'), 'logEntry', '__httpdataone_orgservicetypes0_6_0_CTD_ANON_logEntry', True)
...
SystemMetadata._GroupModel = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(SystemMetadata._UseForTag(pyxb.namespace.ExpandedName(None, u'accessPolicy')), min_occurs=0L, max_occurs=None),
...
PrincipalList._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'principal'), Principal, scope=PrincipalList))
PrincipalList._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(PrincipalList._UseForTag(pyxb.namespace.ExpandedName(None, u'principal')), min_occurs=1L, max_occurs=None)
    )
...
AccessRule._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(AccessRule._UseForTag(pyxb.namespace.ExpandedName(None, u'principal')), min_occurs=1, max_occurs=None),
    pyxb.binding.content.ParticleModel(AccessRule._UseForTag(pyxb.namespace.ExpandedName(None, u'permission')), min_occurs=1, max_occurs=None),
    pyxb.binding.content.ParticleModel(AccessRule._UseForTag(pyxb.namespace.ExpandedName(None, u'resource')), min_occurs=1, max_occurs=None)
    )
