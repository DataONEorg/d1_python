...
# Generated 2012-12-10 10:56:03.583129 by PyXB version 1.1.3
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:dd29a04e-42f2-11e2-a269-000c294230b4')
...
QueryField._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'name'), dataoneTypes.NonEmptyString, scope=QueryField, documentation=u'The name of the field as used programmatically when \n            constructing queries or other rferences to the field.'))

QueryField._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'type'), dataoneTypes.NonEmptyString, scope=QueryField, documentation=u'The type of the field, expressed in the language peculiar to the \n          query engine being described.'))
...
QueryEngineList._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'queryEngine'), dataoneTypes.NonEmptyString, scope=QueryEngineList, documentation=u'The name of a queryEngine. This value will be used as a path element in \n            REST API calls and so should not contain characters that will need to be escaped.'))
...
QueryEngineDescription._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'additionalInfo'), dataoneTypes.NonEmptyString, scope=QueryEngineDescription, documentation=u'An optional human readable description of the query engine. This can be \n            used to describe any special capabilities or intended uses for the query engine. For example, \n            a query engine may be tuned to suit a particular audience or domain as opposed to providing \n            a general purpose discovery mechanism.This field may also contain links to additional information about the query engine, \n          such as documentation for the search syntax provided by the query engine implemntors.'))
