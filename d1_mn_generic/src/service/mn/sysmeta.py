...
def is_did(did):
  return mn.models.IdNamespace.objects.filter(
    did=did).exists()
...
def is_pid(did):
  ...
  objects.
  """
  return is_did(did) and not mn.sysmeta_sid.is_sid(did)
