...
project = u'Member Node REST Interface'
copyright = u'2010, Roger Dahl'
...
htmlhelp_basename = 'MemberNodeRESTInterfacedoc'
...
latex_documents = [
  (
    'index', 'MemberNodeRESTInterface.tex', u'Member Node REST Interface Documentation',
    u'Roger Dahl', 'manual'
  ),
]
