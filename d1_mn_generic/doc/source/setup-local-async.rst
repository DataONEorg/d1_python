...
~~~~~~~~~~~~~~~~
  ...
  Add::
    ...
    * * * * * cd /var/local/dataone/gmn/lib/python2.7/site-packages/service && /var/local/dataone/gmn/bin/python ./manage.py process_system_metadata_dirty_queue >>gmn_sysmeta.log 2>&1
