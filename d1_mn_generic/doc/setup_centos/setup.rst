...
This section describes the initial steps in setting up :term:`GMN`. It has been verified CentOS 7.3. Instructions for Ubuntu are :doc:`also available <../setup_ubuntu/setup>`.
...
By completing :doc:`../setup-env`, the stand-alone test instance can then be joined to DataONE as an official Member Node.
