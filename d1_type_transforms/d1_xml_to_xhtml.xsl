...
>
  ...
  <xsl:import href="xslt/implicit.xsl"/>
  <xsl:import href="xslt/debug.xsl"/>
  <xsl:import href="xslt/error.xsl"/>
  <xsl:import href="xslt/gmn_status.xsl"/>
  <xsl:import href="xslt/intermediate.xsl"/>
  <xsl:import href="xslt/log.xsl"/>
  <xsl:import href="xslt/node.xsl"/>
  <xsl:import href="xslt/object_format.xsl"/>
  <xsl:import href="xslt/object_list.xsl"/>
  <xsl:import href="xslt/option_list.xsl"/>
  <xsl:import href="xslt/sysmeta.xsl"/>
  ...
  <xsl:template name="document_header">
    <head>
      <title>DataONE XML Type</title>
      <link href="{concat($static_root_url, 'd1_types.css')}"
