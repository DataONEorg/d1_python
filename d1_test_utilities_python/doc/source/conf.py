...
sys.path.append(os.path.abspath('../../src/d1_test/instance_generator/'))
sys.path.append(os.path.abspath('../../src/d1_test/stress_tester'))
sys.path.append(os.path.abspath('../../src/d1_test/utilities'))

project = u'DataONE Test Utilities for Python'
