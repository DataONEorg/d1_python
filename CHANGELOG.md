...
## [3.4.3](https://github.com/DataONEorg/d1_python/tree/3.4.3) (2019-06-13)
[Full Changelog](https://github.com/DataONEorg/d1_python/compare/3.2.0...3.4.3)
...
- DataONE Client Library
  ...
  - New API documentation for developers
    - https://dataone-python.readthedocs.io/en/latest/client/api/modules.html
...
- DataONE Common Library
  - New API documentation for developers
    - https://dataone-python.readthedocs.io/en/latest/common/api/modules.html
...
- Tests and test framework
  - New API documentation for developers
    - https://dataone-python.readthedocs.io/en/latest/test/api/modules.html
