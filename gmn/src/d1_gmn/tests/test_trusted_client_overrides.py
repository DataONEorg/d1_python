...
"""Test the ability of fully trusted clients, such as Slender Node adapters, to pass
values to GMN that are normally controlled by MNs."""
...
class TestTrustedClientOverrides(d1_gmn.tests.gmn_test_case.GMNTestCase):
    ...
    def test_1000(self):
        ...
        assert accepted_override_list == [False, False, False, False, False, False]
    ...
    def test_1010(self):
        ...
        accepted_override_list = self._test_override(self.client_v1)
        assert accepted_override_list == [True, False, False, False, False, True]
    ...
    def test_1020(self):
        ...
        accepted_override_list = self._test_override(self.client_v1)
        assert accepted_override_list == [True, True, True, True, True, True]
