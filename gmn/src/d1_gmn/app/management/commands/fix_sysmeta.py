...
class FixSystemMetadata(object):
  ...
  def _fix_system_metadata_all(self):
    ...
    for i, sysmeta_pyxb in enumerate(sysmeta_iter):
      ...
      cn_submitter = d1_gmn.app.util.uvalue(sysmeta_pyxb.submitter)
      ...
      if cn_submitter != mn_submitter:
        sciobj_model.submitter = d1_gmn.app.models.subject(cn_submitter)
        sciobj_model.save()
        logging.info(
  ...
  #   num_total = d1_gmn.app.models.ScienceObject.objects.count()
  #   num_checked = 0
