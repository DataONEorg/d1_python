...
def add_bool_filter(request, query, column_name, param_name):
    ...
    return query.filter(**{filter_arg: d1_gmn.app.views.util.is_true_param(bool_val)})
...
def add_sid_or_string_begins_with_filter(request, query, column_name, param_name):
