...
See :doc:`setup_ubuntu/setup-testing`, :doc:`setup_centos/12-setup-testing` and the `DataONE Command Line Interface (CLI) documentation <http://pythonhosted.org/dataone.cli>`_ for more information about how to use the CLI.
