...
See :doc:`/gmn/setup/ubuntu/gmn/testing`, :doc:`/gmn/setup/centos/12-testing` and the `DataONE Command Line Interface (CLI) documentation <http://pythonhosted.org/dataone.cli>`_ for more information about how to use the CLI.
