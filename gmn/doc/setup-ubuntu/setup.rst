...
This section describes the initial steps in setting up :term:`GMN`. It has been verified on Ubuntu 18.04 LTS. Instructions for CentOS are :doc:`also available <../setup-centos/setup>`.
